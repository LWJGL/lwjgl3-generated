...
public class SQL_TIMESTAMP_STRUCT extends Struct implements NativeResource {
    ...
    SQL_TIMESTAMP_STRUCT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link SQL_TIMESTAMP_STRUCT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
