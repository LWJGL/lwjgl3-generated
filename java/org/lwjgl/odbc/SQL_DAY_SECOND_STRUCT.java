...
public class SQL_DAY_SECOND_STRUCT extends Struct implements NativeResource {
    ...
    SQL_DAY_SECOND_STRUCT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link SQL_DAY_SECOND_STRUCT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
