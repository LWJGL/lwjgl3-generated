...
public class SQL_SS_TIMESTAMPOFFSET_STRUCT extends Struct implements NativeResource {
    ...
    SQL_SS_TIMESTAMPOFFSET_STRUCT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link SQL_SS_TIMESTAMPOFFSET_STRUCT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
