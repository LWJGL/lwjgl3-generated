...
public class SQL {
    ...
    /** Array version of: {@link #SQLDataSources DataSources} */
    @NativeType("SQLRETURN")
    public static short SQLDataSources(@NativeType("SQLHENV") long EnvironmentHandle, @NativeType("SQLUSMALLINT") short Direction, @NativeType("SQLWCHAR *") ByteBuffer ServerName, @NativeType("SQLSMALLINT *") short[] NameLength1Ptr, @NativeType("SQLWCHAR *") ByteBuffer Description, @NativeType("SQLSMALLINT *") short[] NameLength2Ptr) {
        long __functionAddress = Functions.DataSources;
        if (CHECKS) {
            check(EnvironmentHandle);
            check(NameLength1Ptr, 1);
        ...
        return callPPPPPS(__functionAddress, EnvironmentHandle, Direction, memAddressSafe(ServerName), (short)(remainingSafe(ServerName) >> 1), NameLength1Ptr, memAddressSafe(Description), (short)(remainingSafe(Description) >> 1), NameLength2Ptr);
    }

    /** Array version of: {@link #SQLGetInfo GetInfo} */
    @NativeType("SQLRETURN")
    public static short SQLGetInfo(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLUSMALLINT") short InfoType, @NativeType("SQLPOINTER") ByteBuffer InfoValuePtr, @NativeType("SQLSMALLINT *") short[] StringLengthPtr) {
        long __functionAddress = Functions.GetInfo;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, ConnectionHandle, InfoType, memAddressSafe(InfoValuePtr), (short)remainingSafe(InfoValuePtr), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetInfo GetInfo} */
    @NativeType("SQLRETURN")
    public static short SQLGetInfo(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLUSMALLINT") short InfoType, @NativeType("SQLPOINTER") short[] InfoValuePtr, @NativeType("SQLSMALLINT *") short[] StringLengthPtr) {
        long __functionAddress = Functions.GetInfo;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, ConnectionHandle, InfoType, InfoValuePtr, (short)(lengthSafe(InfoValuePtr) << 1), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetInfo GetInfo} */
    @NativeType("SQLRETURN")
    public static short SQLGetInfo(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLUSMALLINT") short InfoType, @NativeType("SQLPOINTER") int[] InfoValuePtr, @NativeType("SQLSMALLINT *") short[] StringLengthPtr) {
        long __functionAddress = Functions.GetInfo;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, ConnectionHandle, InfoType, InfoValuePtr, (short)(lengthSafe(InfoValuePtr) << 2), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetFunctions GetFunctions} */
    @NativeType("SQLRETURN")
    public static short SQLGetFunctions(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLUSMALLINT") short FunctionId, @NativeType("SQLUSMALLINT *") short[] SupportedPtr) {
        long __functionAddress = Functions.GetFunctions;
        if (CHECKS) {
            check(ConnectionHandle);
            check(SupportedPtr, 1);
    ...
    /** Array version of: {@link #SQLGetConnectAttr GetConnectAttr} */
    @NativeType("SQLRETURN")
    public static short SQLGetConnectAttr(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLINTEGER") int Attribute, @NativeType("SQLPOINTER") ByteBuffer ValuePtr, @NativeType("SQLINTEGER *") int[] StringLengthPtr) {
        long __functionAddress = Functions.GetConnectAttr;
        if (CHECKS) {
            check(ConnectionHandle);
            check(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, ConnectionHandle, Attribute, memAddressSafe(ValuePtr), remainingSafe(ValuePtr), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetEnvAttr GetEnvAttr} */
    @NativeType("SQLRETURN")
    public static short SQLGetEnvAttr(@NativeType("SQLHENV") long EnvironmentHandle, @NativeType("SQLINTEGER") int Attribute, @NativeType("SQLPOINTER") ByteBuffer ValuePtr, @NativeType("SQLINTEGER *") int[] StringLengthPtr) {
        long __functionAddress = Functions.GetEnvAttr;
        if (CHECKS) {
            check(EnvironmentHandle);
            check(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, EnvironmentHandle, Attribute, memAddressSafe(ValuePtr), remainingSafe(ValuePtr), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetStmtAttr GetStmtAttr} */
    @NativeType("SQLRETURN")
    public static short SQLGetStmtAttr(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLINTEGER") int Attribute, @NativeType("SQLPOINTER") ByteBuffer ValuePtr, @NativeType("SQLINTEGER *") int[] StringLengthPtr) {
        long __functionAddress = Functions.GetStmtAttr;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, StatementHandle, Attribute, memAddressSafe(ValuePtr), remainingSafe(ValuePtr), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetDescField GetDescField} */
    @NativeType("SQLRETURN")
    public static short SQLGetDescField(@NativeType("SQLHDESC") long DescriptorHandle, @NativeType("SQLSMALLINT") short RecNumber, @NativeType("SQLSMALLINT") short FieldIdentifier, @NativeType("SQLPOINTER") ByteBuffer ValuePtr, @NativeType("SQLINTEGER *") int[] StringLengthPtr) {
        long __functionAddress = Functions.GetDescField;
        if (CHECKS) {
            check(DescriptorHandle);
            checkSafe(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, DescriptorHandle, RecNumber, FieldIdentifier, memAddressSafe(ValuePtr), remainingSafe(ValuePtr), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetDescRec GetDescRec} */
    @NativeType("SQLRETURN")
    public static short SQLGetDescRec(@NativeType("SQLHDESC") long DescriptorHandle, @NativeType("SQLSMALLINT") short RecNumber, @NativeType("SQLWCHAR *") ByteBuffer Name, @NativeType("SQLSMALLINT *") short[] StringLengthPtr, @NativeType("SQLSMALLINT *") short[] TypePtr, @NativeType("SQLSMALLINT *") short[] SubTypePtr, @NativeType("SQLLEN *") PointerBuffer LengthPtr, @NativeType("SQLSMALLINT *") short[] PrecisionPtr, @NativeType("SQLSMALLINT *") short[] ScalePtr, @NativeType("SQLSMALLINT *") short[] NullablePtr) {
        long __functionAddress = Functions.GetDescRec;
        if (CHECKS) {
            check(DescriptorHandle);
            checkSafe(StringLengthPtr, 1);
        ...
        return callPPPPPPPPPS(__functionAddress, DescriptorHandle, RecNumber, memAddressSafe(Name), (short)(remainingSafe(Name) >> 1), StringLengthPtr, TypePtr, SubTypePtr, memAddressSafe(LengthPtr), PrecisionPtr, ScalePtr, NullablePtr);
    }

    /** Array version of: {@link #SQLGetCursorName GetCursorName} */
    @NativeType("SQLRETURN")
    public static short SQLGetCursorName(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLWCHAR *") ByteBuffer CursorName, @NativeType("SQLSMALLINT *") short[] NameLengthPtr) {
        long __functionAddress = Functions.GetCursorName;
        if (CHECKS) {
            check(StatementHandle);
            check(NameLengthPtr, 1);
        }
        return callPPPS(__functionAddress, StatementHandle, memAddressSafe(CursorName), (short)(remainingSafe(CursorName) >> 1), NameLengthPtr);
    }

    /** Array version of: {@link #SQLNumResultCols NumResultCols} */
    @NativeType("SQLRETURN")
    public static short SQLNumResultCols(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLSMALLINT *") short[] ColumnCountPtr) {
        long __functionAddress = Functions.NumResultCols;
        if (CHECKS) {
            check(StatementHandle);
            check(ColumnCountPtr, 1);
    ...
    /** Array version of: {@link #SQLDescribeCol DescribeCol} */
    @NativeType("SQLRETURN")
    public static short SQLDescribeCol(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLWCHAR *") ByteBuffer ColumnName, @NativeType("SQLSMALLINT *") short[] NameLengthPtr, @NativeType("SQLSMALLINT *") short[] DataTypePtr, @NativeType("SQLULEN *") PointerBuffer ColumnSizePtr, @NativeType("SQLSMALLINT *") short[] DecimalDigitsPtr, @NativeType("SQLSMALLINT *") short[] NullablePtr) {
        long __functionAddress = Functions.DescribeCol;
        if (CHECKS) {
            check(StatementHandle);
            check(NameLengthPtr, 1);
        ...
        return callPPPPPPPS(__functionAddress, StatementHandle, ColumnNumber, memAddressSafe(ColumnName), (short)(remainingSafe(ColumnName) >> 1), NameLengthPtr, DataTypePtr, memAddress(ColumnSizePtr), DecimalDigitsPtr, NullablePtr);
    }

    /** Array version of: {@link #SQLColAttribute ColAttribute} */
    @NativeType("SQLRETURN")
    public static short SQLColAttribute(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLUSMALLINT") short FieldIdentifier, @NativeType("SQLPOINTER") ByteBuffer CharacterAttributePtr, @NativeType("SQLSMALLINT *") short[] StringLengthPtr, @NativeType("SQLLEN *") PointerBuffer NumericAttributePtr) {
        long __functionAddress = Functions.ColAttribute;
        if (CHECKS) {
            check(StatementHandle);
            check(StringLengthPtr, 1);
        ...
        return callPPPPS(__functionAddress, StatementHandle, ColumnNumber, FieldIdentifier, memAddressSafe(CharacterAttributePtr), (short)remainingSafe(CharacterAttributePtr), StringLengthPtr, memAddress(NumericAttributePtr));
    }

    /** Array version of: {@link #SQLBindCol BindCol} */
    @NativeType("SQLRETURN")
    public static short SQLBindCol(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLSMALLINT") short TargetType, @NativeType("SQLPOINTER") short[] TargetValuePtr, @NativeType("SQLLEN *") PointerBuffer StrLen_or_Ind) {
        long __functionAddress = Functions.BindCol;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(StrLen_or_Ind, 1);
        }
        return callPPPPS(__functionAddress, StatementHandle, ColumnNumber, TargetType, TargetValuePtr, (long)(lengthSafe(TargetValuePtr) << 1), memAddressSafe(StrLen_or_Ind));
    }

    /** Array version of: {@link #SQLBindCol BindCol} */
    @NativeType("SQLRETURN")
    public static short SQLBindCol(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLSMALLINT") short TargetType, @NativeType("SQLPOINTER") int[] TargetValuePtr, @NativeType("SQLLEN *") PointerBuffer StrLen_or_Ind) {
        long __functionAddress = Functions.BindCol;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(StrLen_or_Ind, 1);
        }
        return callPPPPS(__functionAddress, StatementHandle, ColumnNumber, TargetType, TargetValuePtr, (long)(lengthSafe(TargetValuePtr) << 2), memAddressSafe(StrLen_or_Ind));
    }

    /** Array version of: {@link #SQLBindCol BindCol} */
    @NativeType("SQLRETURN")
    public static short SQLBindCol(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLSMALLINT") short TargetType, @NativeType("SQLPOINTER") long[] TargetValuePtr, @NativeType("SQLLEN *") PointerBuffer StrLen_or_Ind) {
        long __functionAddress = Functions.BindCol;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(StrLen_or_Ind, 1);
        }
        return callPPPPS(__functionAddress, StatementHandle, ColumnNumber, TargetType, TargetValuePtr, (long)(lengthSafe(TargetValuePtr) << 3), memAddressSafe(StrLen_or_Ind));
    }

    /** Array version of: {@link #SQLBindCol BindCol} */
    @NativeType("SQLRETURN")
    public static short SQLBindCol(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLSMALLINT") short TargetType, @NativeType("SQLPOINTER") float[] TargetValuePtr, @NativeType("SQLLEN *") PointerBuffer StrLen_or_Ind) {
        long __functionAddress = Functions.BindCol;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(StrLen_or_Ind, 1);
    ...
    /** Array version of: {@link #SQLBindCol BindCol} */
    @NativeType("SQLRETURN")
    public static short SQLBindCol(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ColumnNumber, @NativeType("SQLSMALLINT") short TargetType, @NativeType("SQLPOINTER") double[] TargetValuePtr, @NativeType("SQLLEN *") PointerBuffer StrLen_or_Ind) {
        long __functionAddress = Functions.BindCol;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(StrLen_or_Ind, 1);
    ...
    /** Array version of: {@link #SQLGetDiagField GetDiagField} */
    @NativeType("SQLRETURN")
    public static short SQLGetDiagField(@NativeType("SQLSMALLINT") short HandleType, @NativeType("SQLHANDLE") long Handle, @NativeType("SQLSMALLINT") short RecNumber, @NativeType("SQLSMALLINT") short DiagIdentifier, @NativeType("SQLPOINTER") ByteBuffer DiagInfoPtr, @NativeType("SQLSMALLINT *") short[] StringLengthPtr) {
        long __functionAddress = Functions.GetDiagField;
        if (CHECKS) {
            check(Handle);
            check(StringLengthPtr, 1);
        }
        return callPPPS(__functionAddress, HandleType, Handle, RecNumber, DiagIdentifier, memAddressSafe(DiagInfoPtr), (short)remainingSafe(DiagInfoPtr), StringLengthPtr);
    }

    /** Array version of: {@link #SQLGetDiagRec GetDiagRec} */
    @NativeType("SQLRETURN")
    public static short SQLGetDiagRec(@NativeType("SQLSMALLINT") short HandleType, @NativeType("SQLHANDLE") long Handle, @NativeType("SQLSMALLINT") short RecNumber, @NativeType("SQLWCHAR *") ByteBuffer SQLState, @NativeType("SQLINTEGER *") int[] NativeErrorPtr, @NativeType("SQLWCHAR *") ByteBuffer MessageText, @NativeType("SQLSMALLINT *") short[] TextLengthPtr) {
        long __functionAddress = Functions.GetDiagRec;
        if (CHECKS) {
            check(Handle);
            check(SQLState, 6);
        ...
        return callPPPPPS(__functionAddress, HandleType, Handle, RecNumber, memAddress(SQLState), NativeErrorPtr, memAddressSafe(MessageText), (short)(remainingSafe(MessageText) >> 1), TextLengthPtr);
    }

    /** Array version of: {@link #SQLCompleteAsync CompleteAsync} */
    @NativeType("SQLRETURN")
    public static short SQLCompleteAsync(@NativeType("SQLSMALLINT") short HandleType, @NativeType("SQLHANDLE") long Handle, @NativeType("RETCODE *") short[] AsyncRetCodePtr) {
        long __functionAddress = Functions.CompleteAsync;
        if (CHECKS) {
            check(Handle);
            check(AsyncRetCodePtr, 1);
    ...
    /** Array version of: {@link #SQLDriverConnect DriverConnect} */
    @NativeType("SQLRETURN")
    public static short SQLDriverConnect(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLHWND") long WindowHandle, @NativeType("SQLWCHAR *") ByteBuffer InConnectionString, @NativeType("SQLWCHAR *") ByteBuffer OutConnectionString, @NativeType("SQLSMALLINT *") short[] StringLength2Ptr, @NativeType("SQLUSMALLINT") short DriverCompletion) {
        long __functionAddress = Functions.DriverConnect;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLength2Ptr, 1);
        }
        return callPPPPPS(__functionAddress, ConnectionHandle, WindowHandle, memAddress(InConnectionString), (short)(InConnectionString.remaining() >> 1), memAddressSafe(OutConnectionString), (short)(remainingSafe(OutConnectionString) >> 1), StringLength2Ptr, DriverCompletion);
    }

    /** Array version of: {@link #SQLDriverConnect DriverConnect} */
    @NativeType("SQLRETURN")
    public static short SQLDriverConnect(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLHWND") long WindowHandle, @NativeType("SQLWCHAR *") CharSequence InConnectionString, @NativeType("SQLWCHAR *") ByteBuffer OutConnectionString, @NativeType("SQLSMALLINT *") short[] StringLength2Ptr, @NativeType("SQLUSMALLINT") short DriverCompletion) {
        long __functionAddress = Functions.DriverConnect;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLength2Ptr, 1);
        ...
        try {
            ByteBuffer InConnectionStringEncoded = stack.UTF16(InConnectionString, false);
            return callPPPPPS(__functionAddress, ConnectionHandle, WindowHandle, memAddress(InConnectionStringEncoded), (short)(InConnectionStringEncoded.remaining() >> 1), memAddressSafe(OutConnectionString), (short)(remainingSafe(OutConnectionString) >> 1), StringLength2Ptr, DriverCompletion);
        } finally {
            stack.setPointer(stackPointer);
        }
    }

    /** Array version of: {@link #SQLBrowseConnect BrowseConnect} */
    @NativeType("SQLRETURN")
    public static short SQLBrowseConnect(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLWCHAR *") ByteBuffer InConnectionString, @NativeType("SQLWCHAR *") ByteBuffer OutConnectionString, @NativeType("SQLSMALLINT *") short[] StringLength2Ptr) {
        long __functionAddress = Functions.BrowseConnect;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLength2Ptr, 1);
        }
        return callPPPPS(__functionAddress, ConnectionHandle, memAddress(InConnectionString), (short)(InConnectionString.remaining() >> 1), memAddressSafe(OutConnectionString), (short)(remainingSafe(OutConnectionString) >> 1), StringLength2Ptr);
    }

    /** Array version of: {@link #SQLBrowseConnect BrowseConnect} */
    @NativeType("SQLRETURN")
    public static short SQLBrowseConnect(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLWCHAR *") CharSequence InConnectionString, @NativeType("SQLWCHAR *") ByteBuffer OutConnectionString, @NativeType("SQLSMALLINT *") short[] StringLength2Ptr) {
        long __functionAddress = Functions.BrowseConnect;
        if (CHECKS) {
            check(ConnectionHandle);
            checkSafe(StringLength2Ptr, 1);
        ...
        try {
            ByteBuffer InConnectionStringEncoded = stack.UTF16(InConnectionString, false);
            return callPPPPS(__functionAddress, ConnectionHandle, memAddress(InConnectionStringEncoded), (short)(InConnectionStringEncoded.remaining() >> 1), memAddressSafe(OutConnectionString), (short)(remainingSafe(OutConnectionString) >> 1), StringLength2Ptr);
        } finally {
            stack.setPointer(stackPointer);
        }
    }

    /** Array version of: {@link #SQLDescribeParam DescribeParam} */
    @NativeType("SQLRETURN")
    public static short SQLDescribeParam(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLUSMALLINT") short ParameterNumber, @NativeType("SQLSMALLINT *") short[] DataTypePtr, @NativeType("SQLULEN *") PointerBuffer ParameterSizePtr, @NativeType("SQLSMALLINT *") short[] DecimalDigitsPtr, @NativeType("SQLSMALLINT *") short[] NullablePtr) {
        long __functionAddress = Functions.DescribeParam;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(DataTypePtr, 1);
        ...
        return callPPPPPS(__functionAddress, StatementHandle, ParameterNumber, DataTypePtr, memAddressSafe(ParameterSizePtr), DecimalDigitsPtr, NullablePtr);
    }

    /** Array version of: {@link #SQLExtendedFetch ExtendedFetch} */
    @NativeType("SQLRETURN")
    public static short SQLExtendedFetch(@NativeType("SQLHSTMT") long hstmt, @NativeType("SQLUSMALLINT") short fFetchType, @NativeType("SQLLEN") long irow, @NativeType("SQLULEN *") PointerBuffer pcrow, @NativeType("SQLUSMALLINT *") short[] rgfRowStatus) {
        long __functionAddress = Functions.ExtendedFetch;
        if (CHECKS) {
            check(hstmt);
            checkSafe(pcrow, 1);
        ...
        return callPPPPS(__functionAddress, hstmt, fFetchType, irow, memAddressSafe(pcrow), rgfRowStatus);
    }

    /** Array version of: {@link #SQLNativeSql NativeSql} */
    @NativeType("SQLRETURN")
    public static short SQLNativeSql(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLWCHAR *") ByteBuffer InStatementText, @NativeType("SQLWCHAR *") ByteBuffer OutStatementText, @NativeType("SQLINTEGER *") int[] TextLength2Ptr) {
        long __functionAddress = Functions.NativeSql;
        if (CHECKS) {
            check(ConnectionHandle);
            check(TextLength2Ptr, 1);
        }
        return callPPPPS(__functionAddress, ConnectionHandle, memAddress(InStatementText), InStatementText.remaining() >> 1, memAddressSafe(OutStatementText), remainingSafe(OutStatementText) >> 1, TextLength2Ptr);
    }

    /** Array version of: {@link #SQLNativeSql NativeSql} */
    @NativeType("SQLRETURN")
    public static short SQLNativeSql(@NativeType("SQLHDBC") long ConnectionHandle, @NativeType("SQLWCHAR *") CharSequence InStatementText, @NativeType("SQLWCHAR *") ByteBuffer OutStatementText, @NativeType("SQLINTEGER *") int[] TextLength2Ptr) {
        long __functionAddress = Functions.NativeSql;
        if (CHECKS) {
            check(ConnectionHandle);
            check(TextLength2Ptr, 1);
        ...
        try {
            ByteBuffer InStatementTextEncoded = stack.UTF16(InStatementText, false);
            return callPPPPS(__functionAddress, ConnectionHandle, memAddress(InStatementTextEncoded), InStatementTextEncoded.remaining() >> 1, memAddressSafe(OutStatementText), remainingSafe(OutStatementText) >> 1, TextLength2Ptr);
        } finally {
            stack.setPointer(stackPointer);
        }
    }

    /** Array version of: {@link #SQLNumParams NumParams} */
    @NativeType("SQLRETURN")
    public static short SQLNumParams(@NativeType("SQLHSTMT") long StatementHandle, @NativeType("SQLSMALLINT *") short[] ParameterCountPtr) {
        long __functionAddress = Functions.NumParams;
        if (CHECKS) {
            check(StatementHandle);
            checkSafe(ParameterCountPtr, 1);
    ...
    /** Array version of: {@link #SQLDrivers Drivers} */
    @NativeType("SQLRETURN")
    public static short SQLDrivers(@NativeType("SQLHENV") long EnvironmentHandle, @NativeType("SQLUSMALLINT") short Direction, @NativeType("SQLWCHAR *") ByteBuffer DriverDescription, @NativeType("SQLSMALLINT *") short[] DescriptionLengthPtr, @NativeType("SQLWCHAR *") ByteBuffer DriverAttributes, @NativeType("SQLSMALLINT *") short[] AttributesLengthPtr) {
        long __functionAddress = Functions.Drivers;
        if (CHECKS) {
            check(EnvironmentHandle);
            checkSafe(DescriptionLengthPtr, 1);
        ...
        return callPPPPPS(__functionAddress, EnvironmentHandle, Direction, memAddressSafe(DriverDescription), (short)(remainingSafe(DriverDescription) >> 1), DescriptionLengthPtr, memAddressSafe(DriverAttributes), (short)(remainingSafe(DriverAttributes) >> 1), AttributesLengthPtr);
    }
