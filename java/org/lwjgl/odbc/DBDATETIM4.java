...
public class DBDATETIM4 extends Struct implements NativeResource {
    ...
    DBDATETIM4(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link DBDATETIM4} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
