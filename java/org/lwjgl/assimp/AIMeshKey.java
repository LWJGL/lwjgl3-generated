...
public class AIMeshKey extends Struct implements NativeResource {
	...
	/** Unsafe version of {@link #set(AIMeshKey) set}. */
	public AIMeshKey nset(long struct) {
	...
	/** Returns a new {@link AIMeshKey} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
