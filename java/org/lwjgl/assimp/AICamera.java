...
public class AICamera extends Struct implements NativeResource {
    ...
    AICamera(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link AICamera} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
