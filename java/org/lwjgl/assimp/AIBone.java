...
public class AIBone extends Struct implements NativeResource {
	...
	/** Unsafe version of {@link #set(AIBone) set}. */
	public AIBone nset(long struct) {
	...
	/** Returns a new {@link AIBone} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
