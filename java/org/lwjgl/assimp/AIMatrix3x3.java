...
public class AIMatrix3x3 extends Struct implements NativeResource {
	...
	AIMatrix3x3(long address, ByteBuffer container) {
	...
	/** Unsafe version of {@link #set(AIMatrix3x3) set}. */
	public AIMatrix3x3 nset(long struct) {
	...
	/** Returns a new {@link AIMatrix3x3} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
