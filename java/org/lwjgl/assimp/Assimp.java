...
x1</code></pre>
	...
	private static final SharedLibrary ASSIMP = Library.loadNative(Configuration.ASSIMP_LIBRARY_NAME.get(Platform.mapLibraryNameBundled("assimp")));
	 ...
	 *                       ({@link #aiProcess_MakeLeftHanded Process_MakeLeftHanded}, {@link #aiProcess_FlipUVs Process_FlipUVs} and {@link #aiProcess_FlipWindingOrder Process_FlipWindingOrder}). One or more of:<br></p><table><tr><td>{@link #aiProcessPreset_TargetRealtime_Fast ProcessPreset_TargetRealtime_Fast}</td><td>{@link #aiProcessPreset_TargetRealtime_MaxQuality ProcessPreset_TargetRealtime_MaxQuality}</td><td>{@link #aiProcessPreset_TargetRealtime_Quality ProcessPreset_TargetRealtime_Quality}</td></tr><tr><td>{@link #aiProcess_CalcTangentSpace Process_CalcTangentSpace}</td><td>{@link #aiProcess_ConvertToLeftHanded Process_ConvertToLeftHanded}</td><td>{@link #aiProcess_Debone Process_Debone}</td></tr><tr><td>{@link #aiProcess_FindDegenerates Process_FindDegenerates}</td><td>{@link #aiProcess_FindInstances Process_FindInstances}</td><td>{@link #aiProcess_FindInvalidData Process_FindInvalidData}</td></tr><tr><td>{@link #aiProcess_FixInfacingNormals Process_FixInfacingNormals}</td><td>{@link #aiProcess_FlipUVs Process_FlipUVs}</td><td>{@link #aiProcess_FlipWindingOrder Process_FlipWindingOrder}</td></tr><tr><td>{@link #aiProcess_GenNormals Process_GenNormals}</td><td>{@link #aiProcess_GenSmoothNormals Process_GenSmoothNormals}</td><td>{@link #aiProcess_GenUVCoords Process_GenUVCoords}</td></tr><tr><td>{@link #aiProcess_ImproveCacheLocality Process_ImproveCacheLocality}</td><td>{@link #aiProcess_JoinIdenticalVertices Process_JoinIdenticalVertices}</td><td>{@link #aiProcess_LimitBoneWeights Process_LimitBoneWeights}</td></tr><tr><td>{@link #aiProcess_MakeLeftHanded Process_MakeLeftHanded}</td><td>{@link #aiProcess_OptimizeGraph Process_OptimizeGraph}</td><td>{@link #aiProcess_OptimizeMeshes Process_OptimizeMeshes}</td></tr><tr><td>{@link #aiProcess_PreTransformVertices Process_PreTransformVertices}</td><td>{@link #aiProcess_RemoveComponent Process_RemoveComponent}</td><td>{@link #aiProcess_RemoveRedundantMaterials Process_RemoveRedundantMaterials}</td></tr><tr><td>{@link #aiProcess_SortByPType Process_SortByPType}</td><td>{@link #aiProcess_SplitByBoneCount Process_SplitByBoneCount}</td><td>{@link #aiProcess_SplitLargeMeshes Process_SplitLargeMeshes}</td></tr><tr><td>{@link #aiProcess_TransformUVCoords Process_TransformUVCoords}</td><td>{@link #aiProcess_Triangulate Process_Triangulate}</td><td>{@link #aiProcess_ValidateDataStructure Process_ValidateDataStructure}</td></tr></table>
	 *
	 ...
	 *               your post-processing setup, consider to use {@link #aiApplyPostProcessing ApplyPostProcessing}. One or more of:<br><table><tr><td>{@link #aiProcessPreset_TargetRealtime_Fast ProcessPreset_TargetRealtime_Fast}</td><td>{@link #aiProcessPreset_TargetRealtime_MaxQuality ProcessPreset_TargetRealtime_MaxQuality}</td><td>{@link #aiProcessPreset_TargetRealtime_Quality ProcessPreset_TargetRealtime_Quality}</td></tr><tr><td>{@link #aiProcess_CalcTangentSpace Process_CalcTangentSpace}</td><td>{@link #aiProcess_ConvertToLeftHanded Process_ConvertToLeftHanded}</td><td>{@link #aiProcess_Debone Process_Debone}</td></tr><tr><td>{@link #aiProcess_FindDegenerates Process_FindDegenerates}</td><td>{@link #aiProcess_FindInstances Process_FindInstances}</td><td>{@link #aiProcess_FindInvalidData Process_FindInvalidData}</td></tr><tr><td>{@link #aiProcess_FixInfacingNormals Process_FixInfacingNormals}</td><td>{@link #aiProcess_FlipUVs Process_FlipUVs}</td><td>{@link #aiProcess_FlipWindingOrder Process_FlipWindingOrder}</td></tr><tr><td>{@link #aiProcess_GenNormals Process_GenNormals}</td><td>{@link #aiProcess_GenSmoothNormals Process_GenSmoothNormals}</td><td>{@link #aiProcess_GenUVCoords Process_GenUVCoords}</td></tr><tr><td>{@link #aiProcess_ImproveCacheLocality Process_ImproveCacheLocality}</td><td>{@link #aiProcess_JoinIdenticalVertices Process_JoinIdenticalVertices}</td><td>{@link #aiProcess_LimitBoneWeights Process_LimitBoneWeights}</td></tr><tr><td>{@link #aiProcess_MakeLeftHanded Process_MakeLeftHanded}</td><td>{@link #aiProcess_OptimizeGraph Process_OptimizeGraph}</td><td>{@link #aiProcess_OptimizeMeshes Process_OptimizeMeshes}</td></tr><tr><td>{@link #aiProcess_PreTransformVertices Process_PreTransformVertices}</td><td>{@link #aiProcess_RemoveComponent Process_RemoveComponent}</td><td>{@link #aiProcess_RemoveRedundantMaterials Process_RemoveRedundantMaterials}</td></tr><tr><td>{@link #aiProcess_SortByPType Process_SortByPType}</td><td>{@link #aiProcess_SplitByBoneCount Process_SplitByBoneCount}</td><td>{@link #aiProcess_SplitLargeMeshes Process_SplitLargeMeshes}</td></tr><tr><td>{@link #aiProcess_TransformUVCoords Process_TransformUVCoords}</td><td>{@link #aiProcess_Triangulate Process_Triangulate}</td><td>{@link #aiProcess_ValidateDataStructure Process_ValidateDataStructure}</td></tr></table>
	 *
