...
public class VRTextureWithDepth extends Struct implements NativeResource {
    ...
    VRTextureWithDepth(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VRTextureWithDepth} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
