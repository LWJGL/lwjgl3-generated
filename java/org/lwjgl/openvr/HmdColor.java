...
public class HmdColor extends Struct implements NativeResource {
	...
	/** Unsafe version of {@link #set(HmdColor) set}. */
	public HmdColor nset(long struct) {
	...
	/** Returns a new {@link HmdColor} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
