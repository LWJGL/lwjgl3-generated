 ...
 * <h3>Layout</h3>
 * 
 * <pre><code>struct IntersectionMaskRectangle_t {
    float m_flTopLeftX;
    float m_flTopLeftY;
    float m_flWidth;
    float m_flHeight;
...
public class IntersectionMaskRectangle extends Struct implements NativeResource {
	...
	/** Unsafe version of {@link #set(IntersectionMaskRectangle) set}. */
	public IntersectionMaskRectangle nset(long struct) {
	...
	/** Returns a new {@link IntersectionMaskRectangle} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
