...
public class VREventDualAnalog extends Struct {
    ...
    VREventDualAnalog(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VREventDualAnalog} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
    public static VREventDualAnalog create(long address) {
        return address == NULL ? null : new VREventDualAnalog(address, null);
    }
