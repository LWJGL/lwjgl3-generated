 ...
 * <h3>Layout</h3>
 * 
 * <pre><code>union VROverlayIntersectionMaskPrimitive_Data_t {
...
public class VROverlayIntersectionMaskPrimitiveData extends Struct implements NativeResource {
	...
	VROverlayIntersectionMaskPrimitiveData(long address, ByteBuffer container) {
	...
	/** Returns a new {@link VROverlayIntersectionMaskPrimitiveData} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
