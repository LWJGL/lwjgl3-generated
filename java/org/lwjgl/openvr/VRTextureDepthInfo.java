...
public class VRTextureDepthInfo extends Struct implements NativeResource {
    ...
    VRTextureDepthInfo(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VRTextureDepthInfo} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
