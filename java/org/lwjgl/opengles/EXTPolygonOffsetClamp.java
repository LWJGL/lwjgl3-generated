...
public class EXTPolygonOffsetClamp {
	...
	/** Unsafe version of: {@link #glPolygonOffsetClampEXT PolygonOffsetClampEXT} */
	public static native void nglPolygonOffsetClampEXT(float factor, float units, float clamp);
	...
	public static void glPolygonOffsetClampEXT(float factor, float units, float clamp) {
		nglPolygonOffsetClampEXT(factor, units, clamp);
	}
