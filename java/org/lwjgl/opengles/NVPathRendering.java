...
public final class NVPathRendering {
	...
	public static void glPathCommandsNV(int path, ByteBuffer commands, FloatBuffer coords) {
		nglPathCommandsNV(path, commands.remaining(), memAddress(commands), coords.remaining(), GLES20.GL_FLOAT, memAddress(coords));
	}
	...
	public static void glPathCoordsNV(int path, FloatBuffer coords) {
		nglPathCoordsNV(path, coords.remaining(), GLES20.GL_FLOAT, memAddress(coords));
	}
	...
	public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, FloatBuffer coords) {
		nglPathSubCommandsNV(path, commandStart, commandsToDelete, commands.remaining(), memAddress(commands), coords.remaining(), GLES20.GL_FLOAT, memAddress(coords));
	}
	...
	public static void glPathSubCoordsNV(int path, int coordStart, FloatBuffer coords) {
		nglPathSubCoordsNV(path, coordStart, coords.remaining(), GLES20.GL_FLOAT, memAddress(coords));
	}
