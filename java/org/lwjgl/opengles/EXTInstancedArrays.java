...
public final class EXTInstancedArrays {
	...
	/** JNI method for {@link #glVertexAttribDivisorEXT VertexAttribDivisorEXT} */
	@JavadocExclude
	public static native void nglVertexAttribDivisorEXT(int index, int divisor, long __functionAddress);
	...
	public static void glVertexAttribDivisorEXT(int index, int divisor) {
		...
		nglVertexAttribDivisorEXT(index, divisor, __functionAddress);
	}
