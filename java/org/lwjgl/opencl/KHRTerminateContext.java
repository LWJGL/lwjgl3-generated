...
public final class KHRTerminateContext {
	...
	/** JNI method for {@link #clTerminateContextKHR} */
	 ...
	 * <ul>
	 * <li>The execution status of enqueued commands will be {@link #CL_TERMINATED_KHR}. Event objects can be queried using {@link CL10#clGetEventInfo}. Event
	 ...
	 * events can be set. Event objects can be retained and released. {@link CL10#clGetEventProfilingInfo} returns {@link CL10#CL_PROFILING_INFO_NOT_AVAILABLE}.</li>
	 ...
	 * release operations can be performed on the context. All other APIs that use a context as an argument will return {@link #CL_CONTEXT_TERMINATED_KHR}.</li>
	 ...
	 * <li>Once a context has been terminated, all OpenCL API calls that create objects or enqueue commands will return {@link #CL_CONTEXT_TERMINATED_KHR}. APIs
