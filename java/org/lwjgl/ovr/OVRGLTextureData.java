...
public class OVRGLTextureData extends Struct {
	...
	static {
		Layout layout = __struct(
			__member(OVRTextureHeader.SIZEOF, OVRTextureHeader.ALIGNOF),
			__member(4)
		);
	...
	/** Returns a new {@link OVRGLTextureData} instance allocated on the thread-local {@link MemoryStack}. */
	public static OVRGLTextureData mallocStack() {
		return mallocStack(stackGet());
	}

	/** Returns a new {@link OVRGLTextureData} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
	public static OVRGLTextureData callocStack() {
		return callocStack(stackGet());
	}

	/**
	 * Returns a new {@link OVRGLTextureData} instance allocated on the specified {@link MemoryStack}.
	 *
	 * @param stack the stack from which to allocate
	 */
	public static OVRGLTextureData mallocStack(MemoryStack stack) {
		return create(stack.nmalloc(ALIGNOF, SIZEOF));
	}

	/**
	 * Returns a new {@link OVRGLTextureData} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
	 *
	 * @param stack the stack from which to allocate
	 */
	public static OVRGLTextureData callocStack(MemoryStack stack) {
		return create(stack.ncalloc(ALIGNOF, 1, SIZEOF));
	}

	/**
	 * Returns a new {@link OVRGLTextureData.Buffer} instance allocated on the thread-local {@link MemoryStack}.
	 *
	 * @param capacity the buffer capacity
	 */
	...
	/**
	 * Returns a new {@link OVRGLTextureData.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
	 *
	 * @param capacity the buffer capacity
	 */
	...
	/**
	 * Returns a new {@link OVRGLTextureData.Buffer} instance allocated on the specified {@link MemoryStack}.
	 *
	 * @param stack the stack from which to allocate
	 * @param capacity the buffer capacity
	 */
	...
	/**
	 * Returns a new {@link OVRGLTextureData.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
	 *
	 * @param stack the stack from which to allocate
	 * @param capacity the buffer capacity
	 */
	...
	public static final class Buffer extends StructBuffer<OVRGLTextureData, Buffer> {
		...
		protected OVRGLTextureData newInstance(long address) {
			return new OVRGLTextureData(address, getContainer());
		}
