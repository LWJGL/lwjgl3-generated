...
public class OVRTextureLayoutOctilinear extends Struct implements NativeResource {
    ...
    OVRTextureLayoutOctilinear(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link OVRTextureLayoutOctilinear} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
