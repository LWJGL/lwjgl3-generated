...
public class OVRTextureHeader extends Struct {
	...
	/** Returns a new {@link OVRTextureHeader} instance allocated on the thread-local {@link MemoryStack}. */
	public static OVRTextureHeader mallocStack() {
		return mallocStack(stackGet());
	}

	/** Returns a new {@link OVRTextureHeader} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero. */
	public static OVRTextureHeader callocStack() {
		return callocStack(stackGet());
	}

	/**
	 * Returns a new {@link OVRTextureHeader} instance allocated on the specified {@link MemoryStack}.
	 *
	 * @param stack the stack from which to allocate
	 */
	public static OVRTextureHeader mallocStack(MemoryStack stack) {
		return create(stack.nmalloc(ALIGNOF, SIZEOF));
	}

	/**
	 * Returns a new {@link OVRTextureHeader} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
	 *
	 * @param stack the stack from which to allocate
	 */
	public static OVRTextureHeader callocStack(MemoryStack stack) {
		return create(stack.ncalloc(ALIGNOF, 1, SIZEOF));
	}

	/**
	 * Returns a new {@link OVRTextureHeader.Buffer} instance allocated on the thread-local {@link MemoryStack}.
	 *
	 * @param capacity the buffer capacity
	 */
	...
	/**
	 * Returns a new {@link OVRTextureHeader.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
	 *
	 * @param capacity the buffer capacity
	 */
	...
	/**
	 * Returns a new {@link OVRTextureHeader.Buffer} instance allocated on the specified {@link MemoryStack}.
	 *
	 * @param stack the stack from which to allocate
	 * @param capacity the buffer capacity
	 */
	...
	/**
	 * Returns a new {@link OVRTextureHeader.Buffer} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
	 *
	 * @param stack the stack from which to allocate
	 * @param capacity the buffer capacity
	 */
	...
	public static final class Buffer extends StructBuffer<OVRTextureHeader, Buffer> {
		...
		protected OVRTextureHeader newInstance(long address) {
			return new OVRTextureHeader(address, getContainer());
		}
