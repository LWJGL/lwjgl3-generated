 ...
 * 
 * <ul>
 * <li>{@code Type} &ndash; one of:<br><table><tr><td>{@link OVR#ovrTexture_2D Texture_2D}</td><td>{@link OVR#ovrTexture_2D_External Texture_2D_External}</td><td>{@link OVR#ovrTexture_Cube Texture_Cube}</td></tr></table></li>
 * <li>{@code Format} &ndash; one of:<br><table><tr><td>{@link OVR#OVR_FORMAT_UNKNOWN}</td><td>{@link OVR#OVR_FORMAT_B5G6R5_UNORM}</td><td>{@link OVR#OVR_FORMAT_B5G5R5A1_UNORM}</td></tr><tr><td>{@link OVR#OVR_FORMAT_B4G4R4A4_UNORM}</td><td>{@link OVR#OVR_FORMAT_R8G8B8A8_UNORM}</td><td>{@link OVR#OVR_FORMAT_R8G8B8A8_UNORM_SRGB}</td></tr><tr><td>{@link OVR#OVR_FORMAT_B8G8R8A8_UNORM}</td><td>{@link OVR#OVR_FORMAT_B8G8R8A8_UNORM_SRGB}</td><td>{@link OVR#OVR_FORMAT_B8G8R8X8_UNORM}</td></tr><tr><td>{@link OVR#OVR_FORMAT_B8G8R8X8_UNORM_SRGB}</td><td>{@link OVR#OVR_FORMAT_R16G16B16A16_FLOAT}</td><td>{@link OVR#OVR_FORMAT_R11G11B10_FLOAT}</td></tr><tr><td>{@link OVR#OVR_FORMAT_D16_UNORM}</td><td>{@link OVR#OVR_FORMAT_D24_UNORM_S8_UINT}</td><td>{@link OVR#OVR_FORMAT_D32_FLOAT}</td></tr><tr><td>{@link OVR#OVR_FORMAT_D32_FLOAT_S8X24_UINT}</td><td>{@link OVR#OVR_FORMAT_BC1_UNORM}</td><td>{@link OVR#OVR_FORMAT_BC1_UNORM_SRGB}</td></tr><tr><td>{@link OVR#OVR_FORMAT_BC2_UNORM}</td><td>{@link OVR#OVR_FORMAT_BC2_UNORM_SRGB}</td><td>{@link OVR#OVR_FORMAT_BC3_UNORM}</td></tr><tr><td>{@link OVR#OVR_FORMAT_BC3_UNORM_SRGB}</td><td>{@link OVR#OVR_FORMAT_BC6H_UF16}</td><td>{@link OVR#OVR_FORMAT_BC6H_SF16}</td></tr><tr><td>{@link OVR#OVR_FORMAT_BC7_UNORM}</td><td>{@link OVR#OVR_FORMAT_BC7_UNORM_SRGB}</td></tr></table></li>
