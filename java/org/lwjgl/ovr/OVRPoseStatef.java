...
public final class OVRPoseStatef extends Struct {
	...
	public OVRPoseStatef setThePose(OVRPosef ThePose) { nsetThePose(address(), ThePose); return this; }
	public OVRPoseStatef setThePoseOrientation(OVRQuatf Orientation) { nsetThePoseOrientation(address(), Orientation); return this; }
	public OVRPoseStatef setThePoseOrientationX(float x) { nsetThePoseOrientationX(address(), x); return this; }
	public OVRPoseStatef setThePoseOrientationY(float y) { nsetThePoseOrientationY(address(), y); return this; }
	public OVRPoseStatef setThePoseOrientationZ(float z) { nsetThePoseOrientationZ(address(), z); return this; }
	public OVRPoseStatef setThePoseOrientationW(float w) { nsetThePoseOrientationW(address(), w); return this; }
	public OVRPoseStatef setThePosePosition(OVRVector3f Position) { nsetThePosePosition(address(), Position); return this; }
	public OVRPoseStatef setThePosePositionX(float x) { nsetThePosePositionX(address(), x); return this; }
	public OVRPoseStatef setThePosePositionY(float y) { nsetThePosePositionY(address(), y); return this; }
	public OVRPoseStatef setThePosePositionZ(float z) { nsetThePosePositionZ(address(), z); return this; }
	public OVRPoseStatef setAngularVelocity(OVRVector3f AngularVelocity) { nsetAngularVelocity(address(), AngularVelocity); return this; }
	public OVRPoseStatef setAngularVelocityX(float x) { nsetAngularVelocityX(address(), x); return this; }
	public OVRPoseStatef setAngularVelocityY(float y) { nsetAngularVelocityY(address(), y); return this; }
	public OVRPoseStatef setAngularVelocityZ(float z) { nsetAngularVelocityZ(address(), z); return this; }
	public OVRPoseStatef setLinearVelocity(OVRVector3f LinearVelocity) { nsetLinearVelocity(address(), LinearVelocity); return this; }
	public OVRPoseStatef setLinearVelocityX(float x) { nsetLinearVelocityX(address(), x); return this; }
	public OVRPoseStatef setLinearVelocityY(float y) { nsetLinearVelocityY(address(), y); return this; }
	public OVRPoseStatef setLinearVelocityZ(float z) { nsetLinearVelocityZ(address(), z); return this; }
	public OVRPoseStatef setAngularAcceleration(OVRVector3f AngularAcceleration) { nsetAngularAcceleration(address(), AngularAcceleration); return this; }
	public OVRPoseStatef setAngularAccelerationX(float x) { nsetAngularAccelerationX(address(), x); return this; }
	public OVRPoseStatef setAngularAccelerationY(float y) { nsetAngularAccelerationY(address(), y); return this; }
	public OVRPoseStatef setAngularAccelerationZ(float z) { nsetAngularAccelerationZ(address(), z); return this; }
	public OVRPoseStatef setLinearAcceleration(OVRVector3f LinearAcceleration) { nsetLinearAcceleration(address(), LinearAcceleration); return this; }
	public OVRPoseStatef setLinearAccelerationX(float x) { nsetLinearAccelerationX(address(), x); return this; }
	public OVRPoseStatef setLinearAccelerationY(float y) { nsetLinearAccelerationY(address(), y); return this; }
	public OVRPoseStatef setLinearAccelerationZ(float z) { nsetLinearAccelerationZ(address(), z); return this; }
	public OVRPoseStatef setTimeInSeconds(double TimeInSeconds) { nsetTimeInSeconds(address(), TimeInSeconds); return this; }

	/** Initializes this struct with the specified values. */
	public OVRPoseStatef set(
		OVRPosef ThePose,
	...
	public OVRPoseStatef nset(long struct) {
	 ...
	 * @returns this struct
	 */
	public OVRPoseStatef set(OVRPoseStatef src) {
		return nset(address());
	}

	/** {@link ByteBuffer} version of {@link #set}. */
	public OVRPoseStatef set(ByteBuffer struct) {
		if ( LWJGLUtil.CHECKS )
	...
	public static void nsetThePose(long struct, OVRPosef ThePose) { memCopy(ThePose.address(), struct + THEPOSE, OVRPosef.SIZEOF); }
	/** Copies the specified {@link OVRPosef} struct to the nested {@code ThePose} struct. */
	public static void setThePose(ByteBuffer struct, OVRPosef ThePose) { nsetThePose(memAddress(struct), ThePose); }
	public static void nsetThePoseOrientation(long struct, OVRQuatf Orientation) { memCopy(Orientation.address(), struct + THEPOSE + OVRPosef.ORIENTATION, OVRQuatf.SIZEOF); }
	/** Copies the specified {@link OVRQuatf} struct to the nested {@code Orientation} struct. */
	public static void setThePoseOrientation(ByteBuffer struct, OVRQuatf Orientation) { nsetThePoseOrientation(memAddress(struct), Orientation); }
	public static void nsetThePoseOrientationX(long struct, float x) { memPutFloat(struct + THEPOSE + OVRPosef.ORIENTATION + OVRQuatf.X, x); }
	public static void setThePoseOrientationX(ByteBuffer struct, float x) { nsetThePoseOrientationX(memAddress(struct), x); }
	public static void nsetThePoseOrientationY(long struct, float y) { memPutFloat(struct + THEPOSE + OVRPosef.ORIENTATION + OVRQuatf.Y, y); }
	public static void setThePoseOrientationY(ByteBuffer struct, float y) { nsetThePoseOrientationY(memAddress(struct), y); }
	public static void nsetThePoseOrientationZ(long struct, float z) { memPutFloat(struct + THEPOSE + OVRPosef.ORIENTATION + OVRQuatf.Z, z); }
	public static void setThePoseOrientationZ(ByteBuffer struct, float z) { nsetThePoseOrientationZ(memAddress(struct), z); }
	public static void nsetThePoseOrientationW(long struct, float w) { memPutFloat(struct + THEPOSE + OVRPosef.ORIENTATION + OVRQuatf.W, w); }
	public static void setThePoseOrientationW(ByteBuffer struct, float w) { nsetThePoseOrientationW(memAddress(struct), w); }
	public static void nsetThePosePosition(long struct, OVRVector3f Position) { memCopy(Position.address(), struct + THEPOSE + OVRPosef.POSITION, OVRVector3f.SIZEOF); }
	/** Copies the specified {@link OVRVector3f} struct to the nested {@code Position} struct. */
	public static void setThePosePosition(ByteBuffer struct, OVRVector3f Position) { nsetThePosePosition(memAddress(struct), Position); }
	public static void nsetThePosePositionX(long struct, float x) { memPutFloat(struct + THEPOSE + OVRPosef.POSITION + OVRVector3f.X, x); }
	public static void setThePosePositionX(ByteBuffer struct, float x) { nsetThePosePositionX(memAddress(struct), x); }
	public static void nsetThePosePositionY(long struct, float y) { memPutFloat(struct + THEPOSE + OVRPosef.POSITION + OVRVector3f.Y, y); }
	public static void setThePosePositionY(ByteBuffer struct, float y) { nsetThePosePositionY(memAddress(struct), y); }
	public static void nsetThePosePositionZ(long struct, float z) { memPutFloat(struct + THEPOSE + OVRPosef.POSITION + OVRVector3f.Z, z); }
	public static void setThePosePositionZ(ByteBuffer struct, float z) { nsetThePosePositionZ(memAddress(struct), z); }
	public static void nsetAngularVelocity(long struct, OVRVector3f AngularVelocity) { memCopy(AngularVelocity.address(), struct + ANGULARVELOCITY, OVRVector3f.SIZEOF); }
	/** Copies the specified {@link OVRVector3f} struct to the nested {@code AngularVelocity} struct. */
	public static void setAngularVelocity(ByteBuffer struct, OVRVector3f AngularVelocity) { nsetAngularVelocity(memAddress(struct), AngularVelocity); }
	public static void nsetAngularVelocityX(long struct, float x) { memPutFloat(struct + ANGULARVELOCITY + OVRVector3f.X, x); }
	public static void setAngularVelocityX(ByteBuffer struct, float x) { nsetAngularVelocityX(memAddress(struct), x); }
	public static void nsetAngularVelocityY(long struct, float y) { memPutFloat(struct + ANGULARVELOCITY + OVRVector3f.Y, y); }
	public static void setAngularVelocityY(ByteBuffer struct, float y) { nsetAngularVelocityY(memAddress(struct), y); }
	public static void nsetAngularVelocityZ(long struct, float z) { memPutFloat(struct + ANGULARVELOCITY + OVRVector3f.Z, z); }
	public static void setAngularVelocityZ(ByteBuffer struct, float z) { nsetAngularVelocityZ(memAddress(struct), z); }
	public static void nsetLinearVelocity(long struct, OVRVector3f LinearVelocity) { memCopy(LinearVelocity.address(), struct + LINEARVELOCITY, OVRVector3f.SIZEOF); }
	/** Copies the specified {@link OVRVector3f} struct to the nested {@code LinearVelocity} struct. */
	public static void setLinearVelocity(ByteBuffer struct, OVRVector3f LinearVelocity) { nsetLinearVelocity(memAddress(struct), LinearVelocity); }
	public static void nsetLinearVelocityX(long struct, float x) { memPutFloat(struct + LINEARVELOCITY + OVRVector3f.X, x); }
	public static void setLinearVelocityX(ByteBuffer struct, float x) { nsetLinearVelocityX(memAddress(struct), x); }
	public static void nsetLinearVelocityY(long struct, float y) { memPutFloat(struct + LINEARVELOCITY + OVRVector3f.Y, y); }
	public static void setLinearVelocityY(ByteBuffer struct, float y) { nsetLinearVelocityY(memAddress(struct), y); }
	public static void nsetLinearVelocityZ(long struct, float z) { memPutFloat(struct + LINEARVELOCITY + OVRVector3f.Z, z); }
	public static void setLinearVelocityZ(ByteBuffer struct, float z) { nsetLinearVelocityZ(memAddress(struct), z); }
	public static void nsetAngularAcceleration(long struct, OVRVector3f AngularAcceleration) { memCopy(AngularAcceleration.address(), struct + ANGULARACCELERATION, OVRVector3f.SIZEOF); }
	/** Copies the specified {@link OVRVector3f} struct to the nested {@code AngularAcceleration} struct. */
	public static void setAngularAcceleration(ByteBuffer struct, OVRVector3f AngularAcceleration) { nsetAngularAcceleration(memAddress(struct), AngularAcceleration); }
	public static void nsetAngularAccelerationX(long struct, float x) { memPutFloat(struct + ANGULARACCELERATION + OVRVector3f.X, x); }
	public static void setAngularAccelerationX(ByteBuffer struct, float x) { nsetAngularAccelerationX(memAddress(struct), x); }
	public static void nsetAngularAccelerationY(long struct, float y) { memPutFloat(struct + ANGULARACCELERATION + OVRVector3f.Y, y); }
	public static void setAngularAccelerationY(ByteBuffer struct, float y) { nsetAngularAccelerationY(memAddress(struct), y); }
	public static void nsetAngularAccelerationZ(long struct, float z) { memPutFloat(struct + ANGULARACCELERATION + OVRVector3f.Z, z); }
	public static void setAngularAccelerationZ(ByteBuffer struct, float z) { nsetAngularAccelerationZ(memAddress(struct), z); }
	public static void nsetLinearAcceleration(long struct, OVRVector3f LinearAcceleration) { memCopy(LinearAcceleration.address(), struct + LINEARACCELERATION, OVRVector3f.SIZEOF); }
	/** Copies the specified {@link OVRVector3f} struct to the nested {@code LinearAcceleration} struct. */
	public static void setLinearAcceleration(ByteBuffer struct, OVRVector3f LinearAcceleration) { nsetLinearAcceleration(memAddress(struct), LinearAcceleration); }
	public static void nsetLinearAccelerationX(long struct, float x) { memPutFloat(struct + LINEARACCELERATION + OVRVector3f.X, x); }
	public static void setLinearAccelerationX(ByteBuffer struct, float x) { nsetLinearAccelerationX(memAddress(struct), x); }
	public static void nsetLinearAccelerationY(long struct, float y) { memPutFloat(struct + LINEARACCELERATION + OVRVector3f.Y, y); }
	public static void setLinearAccelerationY(ByteBuffer struct, float y) { nsetLinearAccelerationY(memAddress(struct), y); }
	public static void nsetLinearAccelerationZ(long struct, float z) { memPutFloat(struct + LINEARACCELERATION + OVRVector3f.Z, z); }
	public static void setLinearAccelerationZ(ByteBuffer struct, float z) { nsetLinearAccelerationZ(memAddress(struct), z); }
