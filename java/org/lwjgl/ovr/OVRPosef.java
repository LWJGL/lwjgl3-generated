...
public final class OVRPosef implements Pointer {
	...
	public static void OrientationGet(ByteBuffer ovrposef, ByteBuffer Orientation) { checkBuffer(Orientation, OVRQuatf.SIZEOF); memCopy(memAddress(ovrposef) + ORIENTATION, memAddress(Orientation), OVRQuatf.SIZEOF); }
	...
	public static void PositionGet(ByteBuffer ovrposef, ByteBuffer Position) { checkBuffer(Position, OVRVector3f.SIZEOF); memCopy(memAddress(ovrposef) + POSITION, memAddress(Position), OVRVector3f.SIZEOF); }
