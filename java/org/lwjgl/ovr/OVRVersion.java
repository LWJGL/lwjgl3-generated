...
public final class OVRVersion {
	...
	public static final int
		...
		OVR_MAJOR_VERSION   = 0x6,
		OVR_MINOR_VERSION   = 0x0,
		OVR_PATCH_VERSION   = 0x1,
	...
	public static final String OVR_DISPLAY_DRIVER_PRODUCT_VERSION = "1.2.6.0";

	/** The product version for the Oculus Position Tracker Driver. */
	public static final String OVR_POSITIONAL_TRACKER_DRIVER_PRODUCT_VERSION = "1.0.10.0";
