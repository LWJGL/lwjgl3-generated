...
public final class OVRVersion {
	...
	public static final String OVR_DISPLAY_DRIVER_PRODUCT_VERSION = "1.2.8.0";

	/** The product version for the Oculus Position Tracker Driver. */
	public static final String OVR_POSITIONAL_TRACKER_DRIVER_PRODUCT_VERSION = "1.0.14.0";
