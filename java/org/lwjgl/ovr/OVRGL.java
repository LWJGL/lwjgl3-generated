...
public class OVRGL {
	...
	/** JNI method for {@link #ovr_CreateTextureSwapChainGL CreateTextureSwapChainGL} */
	 ...
	 */
	public static int ovr_CreateTextureSwapChainGL(long session, OVRTextureSwapChainDesc desc, ByteBuffer out_TextureSwapChain) {
		if ( CHECKS ) {
			checkPointer(session);
			checkBuffer(out_TextureSwapChain, 1 << POINTER_SHIFT);
		}
		return novr_CreateTextureSwapChainGL(session, desc.address(), memAddress(out_TextureSwapChain));
	}

	/** Alternative version of: {@link #ovr_CreateTextureSwapChainGL CreateTextureSwapChainGL} */
	...
	/** JNI method for {@link #ovr_GetTextureSwapChainBufferGL GetTextureSwapChainBufferGL} */
	 ...
	 * @return an {@code ovrResult} indicating success or failure. In the case of failure, use {@link OVR#ovr_GetLastErrorInfo GetLastErrorInfo} to get more information.
	 */
	public static int ovr_GetTextureSwapChainBufferGL(long session, long chain, int index, ByteBuffer out_TexId) {
		if ( CHECKS ) {
			checkPointer(session);
			checkPointer(chain);
			checkBuffer(out_TexId, 1 << 2);
		}
		return novr_GetTextureSwapChainBufferGL(session, chain, index, memAddress(out_TexId));
	}

	/** Alternative version of: {@link #ovr_GetTextureSwapChainBufferGL GetTextureSwapChainBufferGL} */
	 ...
	 * @return an {@code ovrResult} indicating success or failure. In the case of failure, use {@link OVR#ovr_GetLastErrorInfo GetLastErrorInfo} to get more information.
	 */
	public static int ovr_CreateMirrorTextureGL(long session, OVRMirrorTextureDesc desc, ByteBuffer out_MirrorTexture) {
		if ( CHECKS ) {
			checkPointer(session);
			checkBuffer(out_MirrorTexture, 1 << POINTER_SHIFT);
		}
	...
	/** JNI method for {@link #ovr_GetMirrorTextureBufferGL GetMirrorTextureBufferGL} */
	 ...
	 * @return an {@code ovrResult} indicating success or failure. In the case of failure, use {@link OVR#ovr_GetLastErrorInfo GetLastErrorInfo} to get more information.
	 */
	public static int ovr_GetMirrorTextureBufferGL(long session, long mirrorTexture, ByteBuffer out_TexId) {
		if ( CHECKS ) {
			checkPointer(session);
	...
	/** Alternative version of: {@link #ovr_GetMirrorTextureBufferGL GetMirrorTextureBufferGL} */
