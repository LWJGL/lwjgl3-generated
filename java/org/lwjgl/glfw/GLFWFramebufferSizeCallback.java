...
public abstract class GLFWFramebufferSizeCallback extends Closure.V {

	private static final FFICIF        CIF  = apiClosureCIF();
	private static final PointerBuffer ARGS = apiClosureArgs(3);

	private static final long CLASSPATH = apiClosureText("org.lwjgl.glfw.GLFWFramebufferSizeCallback");
