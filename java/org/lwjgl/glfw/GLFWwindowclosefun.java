...
public abstract class GLFWwindowclosefun extends Closure.Void {
	...
	static {
		...
		if ( status != FFI_OK )
			throw new IllegalStateException(String.format("Failed to prepare GLFWwindowclosefun callback interface. Status: 0x%X", status));
	}

	protected GLFWwindowclosefun() {
		super(CIF);
	}
	...
	/** A functional interface for {@link GLFWwindowclosefun}. */
