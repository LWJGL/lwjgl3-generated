 ...
 * 
 * <p>GLFW comes with extensive documentation, which you can read online <a href="http://www.glfw.org/docs/latest/">here</a>. The
 * <a href="http://www.glfw.org/faq.html">Frequently Asked Questions</a> are also useful.</p>
 * 
 * <p>On Mac OS X the JVM must be started with the {@code -XstartOnFirstThread} argument for GLFW to work. This is necessary because most GLFW functions must
