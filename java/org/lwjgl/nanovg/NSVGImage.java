...
public class NSVGImage extends Struct {
    ...
    NSVGImage(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link NSVGImage} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
