...
public class NSVGPaint extends Struct {
    ...
    NSVGPaint(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link NSVGPaint} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
