...
public class NSVGPath extends Struct {
    ...
    NSVGPath(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link NSVGPath} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
