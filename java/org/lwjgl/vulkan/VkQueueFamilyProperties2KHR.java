...
public class VkQueueFamilyProperties2KHR extends Struct implements NativeResource {
    ...
    VkQueueFamilyProperties2KHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkQueueFamilyProperties2KHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
