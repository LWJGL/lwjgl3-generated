...
public class VkDescriptorBufferInfo extends Struct {
	...
	/** {@link ByteBuffer} version of {@link #set(VkDescriptorBufferInfo) set}. */
	public VkDescriptorBufferInfo set(ByteBuffer struct) {
		if ( CHECKS )
	...
	/** Returns a new {@link VkDescriptorBufferInfo} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkDescriptorBufferInfo malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkDescriptorBufferInfo} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkDescriptorBufferInfo.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkDescriptorBufferInfo.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
