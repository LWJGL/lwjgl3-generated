...
public class VkMemoryWin32HandlePropertiesKHR extends Struct implements NativeResource {
    ...
    VkMemoryWin32HandlePropertiesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkMemoryWin32HandlePropertiesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
