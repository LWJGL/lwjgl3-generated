...
public class VkPipelineSampleLocationsStateCreateInfoEXT extends Struct implements NativeResource {
    ...
    VkPipelineSampleLocationsStateCreateInfoEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPipelineSampleLocationsStateCreateInfoEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
