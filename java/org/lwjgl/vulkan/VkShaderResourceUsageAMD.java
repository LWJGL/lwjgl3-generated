...
public class VkShaderResourceUsageAMD extends Struct {
    ...
    VkShaderResourceUsageAMD(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkShaderResourceUsageAMD} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
