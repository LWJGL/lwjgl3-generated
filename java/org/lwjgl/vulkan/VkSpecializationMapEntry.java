...
public class VkSpecializationMapEntry extends Struct {
	...
	/** {@link ByteBuffer} version of {@link #set(VkSpecializationMapEntry) set}. */
	public VkSpecializationMapEntry set(ByteBuffer struct) {
		if ( CHECKS )
	...
	/** Returns a new {@link VkSpecializationMapEntry} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkSpecializationMapEntry malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkSpecializationMapEntry} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkSpecializationMapEntry.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkSpecializationMapEntry.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
