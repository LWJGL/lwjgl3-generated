...
public class VkDisplayPowerInfoEXT extends Struct implements NativeResource {
	...
	VkDisplayPowerInfoEXT(long address, ByteBuffer container) {
	...
	/** Unsafe version of {@link #set(VkDisplayPowerInfoEXT) set}. */
	public VkDisplayPowerInfoEXT nset(long struct) {
	...
	/** Returns a new {@link VkDisplayPowerInfoEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
