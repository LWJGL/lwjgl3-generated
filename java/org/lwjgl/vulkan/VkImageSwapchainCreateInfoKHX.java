...
public class VkImageSwapchainCreateInfoKHX extends Struct implements NativeResource {
    ...
    VkImageSwapchainCreateInfoKHX(long address, @Nullable ByteBuffer container) {
    ...
    public VkImageSwapchainCreateInfoKHX sType(@NativeType("VkStructureType") int value) { nsType(address(), value); return this; }
    /** Sets the specified value to the {@code pNext} field. */
    public VkImageSwapchainCreateInfoKHX pNext(@NativeType("const void *") long value) { npNext(address(), value); return this; }
    /** Sets the specified value to the {@code swapchain} field. */
    public VkImageSwapchainCreateInfoKHX swapchain(@NativeType("VkSwapchainKHR") long value) { nswapchain(address(), value); return this; }
    ...
    /** Returns a new {@link VkImageSwapchainCreateInfoKHX} instance for the specified memory address. */
    public static VkImageSwapchainCreateInfoKHX create(long address) {
        return new VkImageSwapchainCreateInfoKHX(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImageSwapchainCreateInfoKHX createSafe(long address) {
     ...
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer malloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer calloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer create(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkImageSwapchainCreateInfoKHX.Buffer createSafe(long address, int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkImageSwapchainCreateInfoKHX.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkImageSwapchainCreateInfoKHX, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code sType} field. */
        public VkImageSwapchainCreateInfoKHX.Buffer sType(@NativeType("VkStructureType") int value) { VkImageSwapchainCreateInfoKHX.nsType(address(), value); return this; }
        /** Sets the specified value to the {@code pNext} field. */
        public VkImageSwapchainCreateInfoKHX.Buffer pNext(@NativeType("const void *") long value) { VkImageSwapchainCreateInfoKHX.npNext(address(), value); return this; }
        /** Sets the specified value to the {@code swapchain} field. */
        public VkImageSwapchainCreateInfoKHX.Buffer swapchain(@NativeType("VkSwapchainKHR") long value) { VkImageSwapchainCreateInfoKHX.nswapchain(address(), value); return this; }
