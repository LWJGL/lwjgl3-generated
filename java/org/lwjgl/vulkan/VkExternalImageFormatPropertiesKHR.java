...
public class VkExternalImageFormatPropertiesKHR extends Struct {
    ...
    VkExternalImageFormatPropertiesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkExternalImageFormatPropertiesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
