...
public class VkPipelineTessellationDomainOriginStateCreateInfoKHR extends Struct implements NativeResource {
    ...
    VkPipelineTessellationDomainOriginStateCreateInfoKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPipelineTessellationDomainOriginStateCreateInfoKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
