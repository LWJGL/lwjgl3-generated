...
public class VkImagePlaneMemoryRequirementsInfoKHR extends Struct implements NativeResource {
    ...
    VkImagePlaneMemoryRequirementsInfoKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkImagePlaneMemoryRequirementsInfoKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
