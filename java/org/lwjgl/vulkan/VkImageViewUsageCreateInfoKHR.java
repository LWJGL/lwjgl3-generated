...
public class VkImageViewUsageCreateInfoKHR extends Struct implements NativeResource {
    ...
    VkImageViewUsageCreateInfoKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkImageViewUsageCreateInfoKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
