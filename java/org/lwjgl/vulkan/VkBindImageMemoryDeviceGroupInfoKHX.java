...
public class VkBindImageMemoryDeviceGroupInfoKHX extends Struct implements NativeResource {
    ...
    VkBindImageMemoryDeviceGroupInfoKHX(long address, ByteBuffer container) {
    ...
    public VkBindImageMemoryDeviceGroupInfoKHX pNext(@NativeType("const void *") long value) { npNext(address(), value); return this; }
    /** Sets the address of the specified {@link IntBuffer} to the {@code pDeviceIndices} field. */
    public VkBindImageMemoryDeviceGroupInfoKHX pDeviceIndices(@NativeType("const uint32_t *") IntBuffer value) { npDeviceIndices(address(), value); return this; }
    /** Sets the address of the specified {@link VkRect2D.Buffer} to the {@code pSFRRects} field. */
    public VkBindImageMemoryDeviceGroupInfoKHX pSFRRects(@NativeType("const VkRect2D *") VkRect2D.Buffer value) { npSFRRects(address(), value); return this; }
    ...
    /** Returns a new {@link VkBindImageMemoryDeviceGroupInfoKHX} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
    public static VkBindImageMemoryDeviceGroupInfoKHX create(long address) {
        return address == NULL ? null : new VkBindImageMemoryDeviceGroupInfoKHX(address, null);
    }
    ...
    public static IntBuffer npDeviceIndices(long struct) { return memIntBuffer(memGetAddress(struct + VkBindImageMemoryDeviceGroupInfoKHX.PDEVICEINDICES), ndeviceIndexCount(struct)); }
    ...
    public static VkRect2D.Buffer npSFRRects(long struct) { return VkRect2D.create(memGetAddress(struct + VkBindImageMemoryDeviceGroupInfoKHX.PSFRRECTS), nSFRRectCount(struct)); }
    ...
    public static void npDeviceIndices(long struct, IntBuffer value) { memPutAddress(struct + VkBindImageMemoryDeviceGroupInfoKHX.PDEVICEINDICES, memAddressSafe(value)); ndeviceIndexCount(struct, value == null ? 0 : value.remaining()); }
    ...
    public static void npSFRRects(long struct, VkRect2D.Buffer value) { memPutAddress(struct + VkBindImageMemoryDeviceGroupInfoKHX.PSFRRECTS, memAddressSafe(value)); nSFRRectCount(struct, value == null ? 0 : value.remaining()); }
    ...
    public static class Buffer extends StructBuffer<VkBindImageMemoryDeviceGroupInfoKHX, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code pNext} field. */
        public VkBindImageMemoryDeviceGroupInfoKHX.Buffer pNext(@NativeType("const void *") long value) { VkBindImageMemoryDeviceGroupInfoKHX.npNext(address(), value); return this; }
        /** Sets the address of the specified {@link IntBuffer} to the {@code pDeviceIndices} field. */
        public VkBindImageMemoryDeviceGroupInfoKHX.Buffer pDeviceIndices(@NativeType("const uint32_t *") IntBuffer value) { VkBindImageMemoryDeviceGroupInfoKHX.npDeviceIndices(address(), value); return this; }
        /** Sets the address of the specified {@link VkRect2D.Buffer} to the {@code pSFRRects} field. */
        public VkBindImageMemoryDeviceGroupInfoKHX.Buffer pSFRRects(@NativeType("const VkRect2D *") VkRect2D.Buffer value) { VkBindImageMemoryDeviceGroupInfoKHX.npSFRRects(address(), value); return this; }
