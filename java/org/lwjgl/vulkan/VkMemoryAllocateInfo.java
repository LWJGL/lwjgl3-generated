 ...
 * <h5>Description</h5>
 * 
 * <p>An instance of the {@link VkMemoryAllocateInfo} structure defines a memory import operation if the {@code pNext} chain contains an instance of one of the following structures with a non-zero value for their respective {@code handleType} member:   <b> {@link VkImportMemoryWin32HandleInfoKHR}   </b> {@link VkImportMemoryFdInfoKHR}   * {@link VkImportMemoryHostPointerInfoEXT}</p>
 * 
