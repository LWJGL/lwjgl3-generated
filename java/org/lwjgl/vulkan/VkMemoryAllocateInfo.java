 ...
 * <li>If the {@code pNext} extension chain contains an instance of {@link VkExportMemoryAllocateInfoKHX}, and any of the handle types specified in {@link VkExportMemoryAllocateInfoKHX}{@code ::handleTypes} require a dedicated allocation, as reported by {@link KHRGetPhysicalDeviceProperties2#vkGetPhysicalDeviceImageFormatProperties2KHR GetPhysicalDeviceImageFormatProperties2KHR} in {@link VkExternalImageFormatPropertiesKHX}{@code ::externalMemoryProperties}{@code ::externalMemoryFeatures} or {@link VkExternalBufferPropertiesKHX}{@code ::externalMemoryProperties}{@code ::externalMemoryFeatures}, the {@code pNext} extension chain <b>must</b> contain an instance of {@link VkDedicatedAllocationMemoryAllocateInfoNV} with either its {@code image} or {@code buffer} field set to a value other than {@link VK10#VK_NULL_HANDLE NULL_HANDLE}.</li>
 * <li>If the {@code pNext} extension chain contains an instance of {@link VkExportMemoryAllocateInfoKHX}, it <b>must</b> not contain an instance of {@link VkExportMemoryAllocateInfoNV} or {@link VkExportMemoryWin32HandleInfoNV}.</li>
 * <li>If the {@code pNext} extension chain contains an instance of {@link VkImportMemoryWin32HandleInfoKHX}, it <b>must</b> not contain an instance of {@link VkImportMemoryWin32HandleInfoNV}.</li>
 ...
 * <li>{@code pNext} <b>must</b> be {@code NULL}, or a pointer to a valid instance of {@link VkDedicatedAllocationMemoryAllocateInfoNV}, or {@link VkMemoryAllocateFlagsInfoKHX}</li>
 * </ul>
 * 
 * <h5>See Also</h5>
 * 
