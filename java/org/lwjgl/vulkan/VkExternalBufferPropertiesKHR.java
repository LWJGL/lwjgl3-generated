...
public class VkExternalBufferPropertiesKHR extends Struct implements NativeResource {
    ...
    VkExternalBufferPropertiesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkExternalBufferPropertiesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
