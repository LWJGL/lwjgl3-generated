...
public class VkImportMemoryFdInfoKHR extends Struct implements NativeResource {
    ...
    VkImportMemoryFdInfoKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkImportMemoryFdInfoKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
