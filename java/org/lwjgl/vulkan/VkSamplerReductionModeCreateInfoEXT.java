...
public class VkSamplerReductionModeCreateInfoEXT extends Struct implements NativeResource {
    ...
    VkSamplerReductionModeCreateInfoEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkSamplerReductionModeCreateInfoEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
