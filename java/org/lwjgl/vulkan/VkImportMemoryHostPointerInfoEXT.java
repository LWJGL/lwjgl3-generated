...
public class VkImportMemoryHostPointerInfoEXT extends Struct implements NativeResource {
    ...
    VkImportMemoryHostPointerInfoEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkImportMemoryHostPointerInfoEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
