...
public class VkPhysicalDeviceVariablePointerFeaturesKHR extends Struct implements NativeResource {
    ...
    VkPhysicalDeviceVariablePointerFeaturesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPhysicalDeviceVariablePointerFeaturesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
