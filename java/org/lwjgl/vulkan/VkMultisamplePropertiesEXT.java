...
public class VkMultisamplePropertiesEXT extends Struct implements NativeResource {
    ...
    VkMultisamplePropertiesEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkMultisamplePropertiesEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
