 ...
 * <li>If the {@code pNext} extension chain contains an instance of {@link VkExternalMemoryImageCreateInfoKHX}, and any of the handle types specified in {@link VkExternalMemoryImageCreateInfoKHX}{@code ::handleTypes} require a dedicated allocation, as reported by {@link KHRGetPhysicalDeviceProperties2#vkGetPhysicalDeviceImageFormatProperties2KHR GetPhysicalDeviceImageFormatProperties2KHR} in {@link VkExternalImageFormatPropertiesKHX}{@code ::externalMemoryProperties}{@code ::externalMemoryFeatures}, the {@code pNext} extension chain <b>must</b> contain an instance of {@link VkDedicatedAllocationImageCreateInfoNV} with its {@code dedicatedAllocation} field set to {@link VK10#VK_TRUE TRUE}.</li>
 * <li>If the {@code pNext} extension chain contains an instance of {@link VkExternalMemoryImageCreateInfoKHX}, its {@code handleTypes} member <b>must</b> only contain bits that are also in {@link VkExternalImageFormatPropertiesKHX}{@code ::externalMemoryProperties}{@code ::compatibleHandleTypes}, as returned by {@link KHRGetPhysicalDeviceProperties2#vkGetPhysicalDeviceImageFormatProperties2KHR GetPhysicalDeviceImageFormatProperties2KHR} with {@code format}, {@code type}, {@code tiling}, {@code usage}, and {@code flags} equal to those in this structure, and with an instance of {@link VkPhysicalDeviceExternalImageFormatInfoKHX} in the {@code pNext} structure chain, with a {@code handleType} equal to any one of the handle types specified in {@link VkExternalMemoryImageCreateInfoKHX}{@code ::handleTypes}</li>
 * <li>If the {@code pNext} extension chain contains an instance of {@link VkExternalMemoryImageCreateInfoNV}, its {@code handleTypes} member <b>must</b> only contain bits that are also in {@link VkExternalImageFormatPropertiesNV}{@code ::externalMemoryProperties}{@code ::compatibleHandleTypes}, as returned by {@link NVExternalMemoryCapabilities#vkGetPhysicalDeviceExternalImageFormatPropertiesNV GetPhysicalDeviceExternalImageFormatPropertiesNV} with {@code format}, {@code type}, {@code tiling}, {@code usage}, and {@code flags} equal to those in this structure, and with {@code externalHandleType} equal to any one of the handle types specified in {@link VkExternalMemoryImageCreateInfoNV}{@code ::handleTypes}</li>
