 ...
 * <li>If the {@code pNext} chain contains an instance of {@link VkExternalMemoryImageCreateInfoNV}, it <b>must</b> not contain an instance of {@link VkExternalMemoryImageCreateInfoKHX}.</li>
 * <li>If the {@code pNext} chain contains an instance of {@link VkExternalMemoryImageCreateInfoKHX}, and any of the handle types specified in {@link VkExternalMemoryImageCreateInfoKHX}{@code ::handleTypes} require a dedicated allocation, as reported by {@link KHRGetPhysicalDeviceProperties2#vkGetPhysicalDeviceImageFormatProperties2KHR GetPhysicalDeviceImageFormatProperties2KHR} in {@link VkExternalImageFormatPropertiesKHX}{@code ::externalMemoryProperties}{@code ::externalMemoryFeatures}, the {@code pNext} chain <b>must</b> contain an instance of {@link VkDedicatedAllocationImageCreateInfoNV} with its {@code dedicatedAllocation} field set to {@link VK10#VK_TRUE TRUE}.</li>
 * <li>If the {@code pNext} chain contains an instance of {@link VkExternalMemoryImageCreateInfoKHX}, its {@code handleTypes} member <b>must</b> only contain bits that are also in {@link VkExternalImageFormatPropertiesKHX}{@code ::externalMemoryProperties}{@code ::compatibleHandleTypes}, as returned by {@link KHRGetPhysicalDeviceProperties2#vkGetPhysicalDeviceImageFormatProperties2KHR GetPhysicalDeviceImageFormatProperties2KHR} with {@code format}, {@code type}, {@code tiling}, {@code usage}, and {@code flags} equal to those in this structure, and with an instance of {@link VkPhysicalDeviceExternalImageFormatInfoKHX} in the {@code pNext} chain, with a {@code handleType} equal to any one of the handle types specified in {@link VkExternalMemoryImageCreateInfoKHX}{@code ::handleTypes}</li>
 ...
 * <li>Each {@code pNext} member of any structure (including this one) in the {@code pNext} chain <b>must</b> be either {@code NULL} or a pointer to a valid instance of {@link VkDedicatedAllocationImageCreateInfoNV} or {@link VkImageSwapchainCreateInfoKHX}</li>
