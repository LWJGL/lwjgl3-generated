 ...
 * <li>If {@code image} is not {@code VK_NULL_HANDLE}, {@code image} <b>must</b> have been created without {@link VK10#VK_IMAGE_CREATE_SPARSE_BINDING_BIT IMAGE_CREATE_SPARSE_BINDING_BIT} set in {@link VkImageCreateInfo}{@code ::flags}</li>
 ...
 * <li>If {@code buffer} is not {@code VK_NULL_HANDLE}, {@code buffer} <b>must</b> have been created without {@link VK10#VK_BUFFER_CREATE_SPARSE_BINDING_BIT BUFFER_CREATE_SPARSE_BINDING_BIT} set in {@link VkBufferCreateInfo}{@code ::flags}</li>
...
public class VkMemoryDedicatedAllocateInfoKHR extends Struct implements NativeResource {
    ...
    VkMemoryDedicatedAllocateInfoKHR(long address, ByteBuffer container) {
