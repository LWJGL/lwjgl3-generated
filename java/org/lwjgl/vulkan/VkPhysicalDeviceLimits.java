...
public class VkPhysicalDeviceLimits extends Struct {
	...
	/** Returns a new {@link VkPhysicalDeviceLimits} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkPhysicalDeviceLimits malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkPhysicalDeviceLimits} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkPhysicalDeviceLimits.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkPhysicalDeviceLimits.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
