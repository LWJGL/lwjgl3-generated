...
public class KHXDeviceGroupCreation {
     ...
     * <li>If the value referenced by {@code pPhysicalDeviceGroupCount} is not 0, and {@code pPhysicalDeviceGroupProperties} is not {@code NULL}, {@code pPhysicalDeviceGroupProperties} <b>must</b> be a valid pointer to an array of {@code pPhysicalDeviceGroupCount} {@link VkPhysicalDeviceGroupPropertiesKHX} structures</li>
     * </ul>
     * 
     * <h5>Return Codes</h5>
     * 
