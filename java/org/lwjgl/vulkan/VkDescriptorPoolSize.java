...
public class VkDescriptorPoolSize extends Struct {
	...
	/** {@link ByteBuffer} version of {@link #set(VkDescriptorPoolSize) set}. */
	public VkDescriptorPoolSize set(ByteBuffer struct) {
		if ( CHECKS )
	...
	/** Returns a new {@link VkDescriptorPoolSize} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkDescriptorPoolSize malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkDescriptorPoolSize} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkDescriptorPoolSize.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkDescriptorPoolSize.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
