...
public class VkExportSemaphoreWin32HandleInfoKHR extends Struct implements NativeResource {
    ...
    public static void npAttributes(long struct, SECURITY_ATTRIBUTES value) { memPutAddress(struct + VkExportSemaphoreWin32HandleInfoKHR.PATTRIBUTES, addressSafe(value)); }
