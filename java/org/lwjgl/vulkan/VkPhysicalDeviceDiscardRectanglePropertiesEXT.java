...
public class VkPhysicalDeviceDiscardRectanglePropertiesEXT extends Struct implements NativeResource {
    ...
    VkPhysicalDeviceDiscardRectanglePropertiesEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPhysicalDeviceDiscardRectanglePropertiesEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
