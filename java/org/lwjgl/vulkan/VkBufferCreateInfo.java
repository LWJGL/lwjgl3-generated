 ...
 * <li>If the {@code pNext} chain contains an instance of {@link VkExternalMemoryBufferCreateInfoKHR}, its {@code handleTypes} member <b>must</b> only contain bits that are also in {@link VkExternalBufferPropertiesKHR}{@code ::externalMemoryProperties}.{@code compatibleHandleTypes}, as returned by {@link KHRExternalMemoryCapabilities#vkGetPhysicalDeviceExternalBufferPropertiesKHR GetPhysicalDeviceExternalBufferPropertiesKHR} with {@code pExternalBufferInfo}&#8594;{@code handleType} equal to any one of the handle types specified in {@link VkExternalMemoryBufferCreateInfoKHR}{@code ::handleTypes}</li>
 ...
 * <li>Each {@code pNext} member of any structure (including this one) in the {@code pNext} chain <b>must</b> be either {@code NULL} or a pointer to a valid instance of {@link VkDedicatedAllocationBufferCreateInfoNV} or {@link VkExternalMemoryBufferCreateInfoKHR}</li>
