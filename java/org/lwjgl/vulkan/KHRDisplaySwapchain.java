...
public class KHRDisplaySwapchain {
	 ...
	 * <h5>Description</h5>
	 * 
	 * <p>{@link #vkCreateSharedSwapchains CreateSharedSwapchains} is similar to {@link KHRSwapchain#vkCreateSwapchainKHR CreateSwapchainKHR}, except that it takes an array of {@link VkSwapchainCreateInfoKHR} structures, and returns an array of swapchain objects.</p>
	 * 
