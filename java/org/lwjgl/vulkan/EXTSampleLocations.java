 ...
 * 
 * <p>Some implementations <b>may</b> need to evaluate depth image values while performing image layout transitions. To accommodate this, instances of the {@link VkSampleLocationsInfoEXT} structure <b>can</b> be specified for each situation where an explicit or automatic layout transition has to take place. {@link VkSampleLocationsInfoEXT} <b>can</b> be chained from {@link VkImageMemoryBarrier} structures to provide sample locations for layout transitions performed by {@link VK10#vkCmdWaitEvents CmdWaitEvents} and flink:VkCmdPipelineBarrier calls, and {@link VkRenderPassSampleLocationsBeginInfoEXT} <b>can</b> be chained from {@link VkRenderPassBeginInfo} to provide sample locations for layout transitions performed implicitly by a render pass instance.</p>
 * 
 * <dl>
...
public class EXTSampleLocations {
     ...
     * <li>{@code pSampleLocationsInfo} <b>must</b> be a pointer to a valid {@link VkSampleLocationsInfoEXT} structure</li>
     ...
     * <li>{@code pMultisampleProperties} <b>must</b> be a pointer to a {@link VkMultisamplePropertiesEXT} structure</li>
     * </ul>
     * 
     * <h5>See Also</h5>
     * 
