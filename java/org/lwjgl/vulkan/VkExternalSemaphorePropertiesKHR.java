...
public class VkExternalSemaphorePropertiesKHR extends Struct implements NativeResource {
    ...
    VkExternalSemaphorePropertiesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkExternalSemaphorePropertiesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
