...
public class VkPresentTimeGOOGLE extends Struct implements NativeResource {
	...
	/** Returns a new {@link VkPresentTimeGOOGLE} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
