...
public class VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT extends Struct {
    ...
    VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
