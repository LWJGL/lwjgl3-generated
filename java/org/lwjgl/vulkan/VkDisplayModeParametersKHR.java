...
public class VkDisplayModeParametersKHR extends Struct {
	...
	/** {@link ByteBuffer} version of {@link #set(VkDisplayModeParametersKHR) set}. */
	public VkDisplayModeParametersKHR set(ByteBuffer struct) {
		if ( CHECKS )
	...
	/** Returns a new {@link VkDisplayModeParametersKHR} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkDisplayModeParametersKHR malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkDisplayModeParametersKHR} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkDisplayModeParametersKHR.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkDisplayModeParametersKHR.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
