...
public class VkPhysicalDeviceExternalMemoryHostPropertiesEXT extends Struct implements NativeResource {
    ...
    VkPhysicalDeviceExternalMemoryHostPropertiesEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPhysicalDeviceExternalMemoryHostPropertiesEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
