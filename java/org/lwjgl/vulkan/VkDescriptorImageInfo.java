...
public class VkDescriptorImageInfo extends Struct {
	...
	/** {@link ByteBuffer} version of {@link #set(VkDescriptorImageInfo) set}. */
	public VkDescriptorImageInfo set(ByteBuffer struct) {
		if ( CHECKS )
	...
	/** Returns a new {@link VkDescriptorImageInfo} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkDescriptorImageInfo malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkDescriptorImageInfo} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkDescriptorImageInfo.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkDescriptorImageInfo.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
	...
	public static long nsampler(long struct) { return memGetAddress(struct + VkDescriptorImageInfo.SAMPLER); }
	/** Unsafe version of {@link #imageView}. */
	public static long nimageView(long struct) { return memGetAddress(struct + VkDescriptorImageInfo.IMAGEVIEW); }
	...
	public static void nsampler(long struct, long value) { memPutAddress(struct + VkDescriptorImageInfo.SAMPLER, value); }
	/** Unsafe version of {@link #imageView(long) imageView}. */
	public static void nimageView(long struct, long value) { memPutAddress(struct + VkDescriptorImageInfo.IMAGEVIEW, value); }
