 ...
 * 
 * <p>If <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html#primsrast-sampleshading">Sample Shading</a> is in use, the coverage bitmask only has bits set for samples that correspond to the fragment shader invocation that shades those samples.</p>
 * 
...
public class VkPipelineCoverageToColorStateCreateInfoNV extends Struct implements NativeResource {
    ...
    VkPipelineCoverageToColorStateCreateInfoNV(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPipelineCoverageToColorStateCreateInfoNV} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
