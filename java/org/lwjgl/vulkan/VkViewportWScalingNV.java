...
public class VkViewportWScalingNV extends Struct implements NativeResource {
	...
	VkViewportWScalingNV(long address, ByteBuffer container) {
	...
	/** Returns a new {@link VkViewportWScalingNV} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
