 ...
 * <li>If the {@code pNext} chain includes {@link VkBindImageMemoryDeviceGroupInfoKHX}, the union of the areas of all elements of {@link VkBindImageMemoryDeviceGroupInfoKHX}{@code ::pSFRRects} that correspond to the same instance of pname: image <b>must</b> cover the entire image.</li>
...
public class VkBindImageMemoryInfoKHR extends Struct implements NativeResource {
    ...
    VkBindImageMemoryInfoKHR(long address, ByteBuffer container) {
