...
public class VkPhysicalDevicePointClippingPropertiesKHR extends Struct {
    ...
    VkPhysicalDevicePointClippingPropertiesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPhysicalDevicePointClippingPropertiesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
