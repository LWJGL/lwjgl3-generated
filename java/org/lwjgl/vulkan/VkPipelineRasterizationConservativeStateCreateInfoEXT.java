...
public class VkPipelineRasterizationConservativeStateCreateInfoEXT extends Struct implements NativeResource {
    ...
    VkPipelineRasterizationConservativeStateCreateInfoEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPipelineRasterizationConservativeStateCreateInfoEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
