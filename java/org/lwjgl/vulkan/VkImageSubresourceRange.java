...
public class VkImageSubresourceRange extends Struct {
	...
	/** {@link ByteBuffer} version of {@link #set(VkImageSubresourceRange) set}. */
	public VkImageSubresourceRange set(ByteBuffer struct) {
		if ( CHECKS )
	...
	/** Returns a new {@link VkImageSubresourceRange} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed. */
	public static VkImageSubresourceRange malloc() {
		return create(nmemAlloc(SIZEOF));
	}

	/** Returns a new {@link VkImageSubresourceRange} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed. */
	...
	/**
	 * Returns a new {@link VkImageSubresourceRange.Buffer} instance allocated with {@link MemoryUtil#memAlloc}. The instance must be explicitly freed.
	 *
	...
	/**
	 * Returns a new {@link VkImageSubresourceRange.Buffer} instance allocated with {@link MemoryUtil#memCalloc}. The instance must be explicitly freed.
	 *
	 * @param capacity the buffer capacity
	 */
