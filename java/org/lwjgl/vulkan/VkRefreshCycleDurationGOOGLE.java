...
public class VkRefreshCycleDurationGOOGLE extends Struct implements NativeResource {
	...
	VkRefreshCycleDurationGOOGLE(long address, ByteBuffer container) {
	...
	/** Returns a new {@link VkRefreshCycleDurationGOOGLE} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
