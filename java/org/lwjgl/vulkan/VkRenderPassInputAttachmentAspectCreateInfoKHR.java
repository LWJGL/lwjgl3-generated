...
public class VkRenderPassInputAttachmentAspectCreateInfoKHR extends Struct implements NativeResource {
    ...
    VkRenderPassInputAttachmentAspectCreateInfoKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkRenderPassInputAttachmentAspectCreateInfoKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
