...
public abstract class VkDebugReportCallbackEXT extends Closure.I {
	 ...
	 * @param object       gives the object where the issue was detected. {@code object} may be {@link VK10#VK_NULL_HANDLE} if there is no object associated with the event.
	 ...
	 *
	 * @return a {@code VkBool32} that indicates to the calling layer if the Vulkan call should be aborted or not. Applications should always return {@link VK10#VK_FALSE} so that
