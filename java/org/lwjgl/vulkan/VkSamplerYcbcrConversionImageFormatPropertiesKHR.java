...
public class VkSamplerYcbcrConversionImageFormatPropertiesKHR extends Struct {
    ...
    VkSamplerYcbcrConversionImageFormatPropertiesKHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkSamplerYcbcrConversionImageFormatPropertiesKHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
