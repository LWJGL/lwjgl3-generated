...
public class VkHdrMetadataEXT extends Struct implements NativeResource {
    ...
    VkHdrMetadataEXT(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkHdrMetadataEXT} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
