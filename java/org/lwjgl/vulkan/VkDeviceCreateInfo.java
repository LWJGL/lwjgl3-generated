 ...
 * <li>Each {@code pNext} member of any structure (including this one) in the {@code pNext} chain <b>must</b> be either {@code NULL} or a pointer to a valid instance of {@link VkPhysicalDeviceFeatures2KHR}, {@link VkPhysicalDeviceMultiviewFeaturesKHX}, or {@link VkDeviceGroupDeviceCreateInfoKHX}</li>
 ...
 * <li>{@code queueCreateInfoCount} &ndash; the unsigned integer size of the {@code pQueueCreateInfos} array. Refer to the <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html#devsandqueues-queue-creation">Queue Creation</a> section below for further details.</li>
 ...
 * <li>{@code ppEnabledLayerNames} &ndash; deprecated and ignored. See <a target="_blank" href="https://www.khronos.org/registry/vulkan/specs/1.0-extensions/xhtml/vkspec.html#extended-functionality-device-layer-deprecation">Device Layer Deprecation</a>.</li>
