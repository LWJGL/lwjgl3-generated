...
public class VkPhysicalDeviceMemoryProperties2KHR extends Struct implements NativeResource {
    ...
    VkPhysicalDeviceMemoryProperties2KHR(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link VkPhysicalDeviceMemoryProperties2KHR} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
