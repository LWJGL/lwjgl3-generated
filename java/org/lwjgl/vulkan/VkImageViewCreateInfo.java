 ...
 * <tr><td>3D, 0, 0</td><td>{@code imageType} = {@link VK10#VK_IMAGE_TYPE_3D IMAGE_TYPE_3D} {@code width} &#x2265; 1 {@code height} &#x2265; 1 {@code depth} &#x2265; 1 {@code arrayLayers} = 1 {@code samples} = 1 {@code flags} includes {@link #IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT} {@code flags} does not include VK_IMAGE_CREATE_SPARSE_BINDING_BIT, VK_IMAGE_CREATE_SPARSE_RESIDENCY_BIT, and VK_IMAGE_CREATE_SPARSE_ALIASED_BIT</td><td>{@code viewType} = {@link #VIEW_TYPE_2D} {@code levelCount} = 1 {@code baseArrayLayer} &#x2265; 0 {@code layerCount} = 1</td></tr>
 * <tr><td>3D, 0, 0</td><td>{@code imageType} = {@link VK10#VK_IMAGE_TYPE_3D IMAGE_TYPE_3D} {@code width} &#x2265; 1 {@code height} &#x2265; 1 {@code depth} &#x2265; 1 {@code arrayLayers} = 1 {@code samples} = 1 {@code flags} includes {@link #IMAGE_CREATE_2D_ARRAY_COMPATIBLE_BIT} {@code flags} does not include VK_IMAGE_CREATE_SPARSE_BINDING_BIT, VK_IMAGE_CREATE_SPARSE_RESIDENCY_BIT, and VK_IMAGE_CREATE_SPARSE_ALIASED_BIT</td><td>{@code viewType} = {@link #VIEW_TYPE_2D_ARRAY} {@code levelCount} = 1 {@code baseArrayLayer} &#x2265; 0 {@code layerCount} &#x2265; 1</td></tr>
 * </tbody>
 * </table>
 * 
 * <h5>Valid Usage</h5>
