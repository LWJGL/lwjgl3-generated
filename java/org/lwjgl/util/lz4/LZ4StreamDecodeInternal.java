...
public class LZ4StreamDecodeInternal extends Struct {
    ...
    LZ4StreamDecodeInternal(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link LZ4StreamDecodeInternal} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
