...
public class LZ4FCompressOptions extends Struct implements NativeResource {
    ...
    LZ4FCompressOptions(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link LZ4FCompressOptions} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
