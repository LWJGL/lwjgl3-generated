...
public class LZ4FPreferences extends Struct implements NativeResource {
    ...
    LZ4FPreferences(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link LZ4FPreferences} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
