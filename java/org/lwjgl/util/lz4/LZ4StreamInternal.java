...
public class LZ4StreamInternal extends Struct {
    ...
    LZ4StreamInternal(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link LZ4StreamInternal} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
