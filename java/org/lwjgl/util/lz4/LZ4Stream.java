...
public class LZ4Stream extends Struct {
    ...
    LZ4Stream(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link LZ4Stream} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
