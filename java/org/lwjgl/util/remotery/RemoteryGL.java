...
public class RemoteryGL {
    ...
    public static void rmt_BeginOpenGLSample(@NativeType("rmtPStr") ByteBuffer name, @NativeType("rmtU32 *") IntBuffer hash_cache) {
        if (CHECKS) {
            checkNT1(name);
    ...
    public static void rmt_BeginOpenGLSample(@NativeType("rmtPStr") CharSequence name, @NativeType("rmtU32 *") IntBuffer hash_cache) {
        if (CHECKS) {
            checkSafe(hash_cache, 1);
        }
