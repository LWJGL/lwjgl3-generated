...
public class ZSTDOutBuffer extends Struct implements NativeResource {
    ...
    ZSTDOutBuffer(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link ZSTDOutBuffer} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
