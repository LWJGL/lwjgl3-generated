...
public class ZDICTCoverParams extends Struct implements NativeResource {
    ...
    ZDICTCoverParams(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link ZDICTCoverParams} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
