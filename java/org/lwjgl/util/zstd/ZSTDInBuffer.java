...
public class ZSTDInBuffer extends Struct implements NativeResource {
    ...
    ZSTDInBuffer(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link ZSTDInBuffer} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
