...
public class ZSTDCustomMem extends Struct implements NativeResource {
    ...
    ZSTDCustomMem(long address, ByteBuffer container) {
    ...
    /** Returns a new {@link ZSTDCustomMem} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
