...
public class OVRMultiview {
     ...
     * 
     * <p>{@link GL11#GL_INVALID_VALUE INVALID_VALUE} is generated by FramebufferTextureMultiviewOVR if {@code numViews} is less than 1, if {@code numViews} is more than {@link #GL_MAX_VIEWS_OVR MAX_VIEWS_OVR} or if</p>
     * 
     * <code>(baseViewIndex + numViews)</code>
     * 
     * <p>exceeds {@link GL30#GL_MAX_ARRAY_TEXTURE_LAYERS MAX_ARRAY_TEXTURE_LAYERS}.</p>
     * 
