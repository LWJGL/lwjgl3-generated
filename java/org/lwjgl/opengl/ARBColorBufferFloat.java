 ...
 * <p/>
 * The default state for fragment clamping is {@link #GL_FIXED_ONLY_ARB FIXED_ONLY_ARB}, which has the behavior of clamping colors for fixed-point color buffers and not clamping
...
public final class ARBColorBufferFloat {
	 ...
	 *
	 * @param target the color target. One of:<p/>{@link #GL_CLAMP_VERTEX_COLOR_ARB CLAMP_VERTEX_COLOR_ARB}, {@link #GL_CLAMP_FRAGMENT_COLOR_ARB CLAMP_FRAGMENT_COLOR_ARB}, {@link #GL_CLAMP_READ_COLOR_ARB CLAMP_READ_COLOR_ARB}
	 * @param clamp  the new clamping state. One of:<p/>{@link GL11#GL_TRUE TRUE}, {@link GL11#GL_FALSE FALSE}, {@link #GL_FIXED_ONLY_ARB FIXED_ONLY_ARB}
	 */
