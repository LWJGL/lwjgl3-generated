...
/**
 * Native bindings to the <a target="_blank" href="http://www.opengl.org/registry/specs/ARB/fragment_program.txt">ARB_fragment_program</a> extension.
 * 
 ...
 * comparisons ({@link ARBDepthTexture ARB_depth_texture}, {@link ARBShadow ARB_shadow}, {@link ARBShadowAmbient ARB_shadow_ambient}, <a target="_blank" href="http://www.opengl.org/registry/specs/EXT/shadow_funcs.txt">EXT_shadow_funcs</a>), per-fragment lighting
 * (<a target="_blank" href="http://www.opengl.org/registry/specs/EXT/fragment_lighting.txt">EXT_fragment_lighting</a>, <a target="_blank" href="http://www.opengl.org/registry/specs/EXT/light_texture.txt">EXT_light_texture</a>), and environment mapped bump mapping
 * (<a target="_blank" href="http://www.opengl.org/registry/specs/ATI/envmap_bumpmap.txt">ATI_envmap_bumpmap</a>).</p>
 * 
