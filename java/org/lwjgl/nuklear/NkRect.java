 ...
 */
public class NkRect extends Struct {
	...
	NkRect(long address, ByteBuffer container) {
	...
	/** Unsafe version of {@link #set(NkRect) set}. */
	public NkRect nset(long struct) {
	...
	/** Returns a new {@link NkRect} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
	...
	public static final class Buffer extends StructBuffer<NkRect, Buffer> {
