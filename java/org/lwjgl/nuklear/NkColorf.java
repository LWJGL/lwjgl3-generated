...
public class NkColorf extends Struct implements NativeResource {
	...
	NkColorf(long address, ByteBuffer container) {
	...
	/** Unsafe version of {@link #set(NkColorf) set}. */
	public NkColorf nset(long struct) {
	...
	/** Returns a new {@link NkColorf} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
	...
	public static final class Buffer extends StructBuffer<NkColorf, Buffer> implements NativeResource {
		...
		protected NkColorf newInstance(long address) {
			return new NkColorf(address, getContainer());
		}
