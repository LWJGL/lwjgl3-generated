...
public class NkStyleCombo extends Struct implements NativeResource {
	...
	/** Unsafe version of {@link #set(NkStyleCombo) set}. */
	public NkStyleCombo nset(long struct) {
	...
	/** Returns a new {@link NkStyleCombo} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
