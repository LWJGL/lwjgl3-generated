 ...
 * <pre><code>struct nk_config_stack_button_behavior {
    int head;
    {@link NkConfigStackButtonBehaviorElement struct nk_config_stack_button_behavior_element}[8] elements;
}</code></pre>
 */
class NkConfigStackButtonBehavior extends Struct {
	...
	public static final class Buffer extends StructBuffer<NkConfigStackButtonBehavior, Buffer> {
		...
		protected NkConfigStackButtonBehavior newInstance(long address) {
			return new NkConfigStackButtonBehavior(address, getContainer());
		}
