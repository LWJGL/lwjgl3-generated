...
public class NkInput extends Struct implements NativeResource {
	...
	NkInput(long address, ByteBuffer container) {
	...
	/** Returns a new {@link NkInput} instance for the specified memory address or {@code null} if the address is {@code NULL}. */
