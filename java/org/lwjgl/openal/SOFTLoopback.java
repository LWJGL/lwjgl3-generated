...
public final class SOFTLoopback {
	 ...
	 * 
	 * <p>The deviceName parameter is used to tell the AL which device or device
	 ...
	 * rendering).</p>
	 * 
	 * <p>A loopback device behaves largely the same as a playback device. You may
	 * query playback state and error codes, and create contexts, which can then
	 * be set as current to generate sources and buffers like normal.</p>
	 * 
	 * <p>Note that loopback devices do not have either the ALC_SYNC or ALC_REFRESH
	 ...
	 * @param channels  channel configuration used for rendering. One of:<br>{@link #ALC_MONO_SOFT MONO_SOFT}, {@link #ALC_STEREO_SOFT STEREO_SOFT}, {@link #ALC_QUAD_SOFT QUAD_SOFT}, {@link #ALC_5POINT1_SOFT 5POINT1_SOFT}, {@link #ALC_6POINT1_SOFT 6POINT1_SOFT}, {@link #ALC_7POINT1_SOFT 7POINT1_SOFT}
