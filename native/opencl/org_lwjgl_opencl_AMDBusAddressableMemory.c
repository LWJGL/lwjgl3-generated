...
typedef cl_int (APIENTRY *clEnqueueMakeBuffersResidentAMDPROC) (cl_command_queue, cl_uint, const cl_mem *, cl_bool, cl_bus_address_amd *, cl_uint, const cl_event *, cl_event *);
