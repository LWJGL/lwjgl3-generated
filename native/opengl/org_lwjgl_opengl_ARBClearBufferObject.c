...
typedef GLvoid (APIENTRY *glClearNamedBufferDataEXTPROC) (GLuint, GLenum, GLenum, GLenum, const GLvoid *);
typedef GLvoid (APIENTRY *glClearNamedBufferSubDataEXTPROC) (GLuint, GLenum, GLintptr, GLsizeiptr, GLenum, GLenum, const GLvoid *);
