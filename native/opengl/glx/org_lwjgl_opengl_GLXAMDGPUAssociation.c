...
typedef void (APIENTRY *glXglXBlitContextFramebufferAMDPROC) (GLXContext, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum);
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_GLXAMDGPUAssociation_nglXglXBlitContextFramebufferAMD(JNIEnv *__env, jclass clazz, jlong dstCtxAddress, jint srcX0, jint srcY0, jint srcX1, jint srcY1, jint dstX0, jint dstY0, jint dstX1, jint dstY1, jint mask, jint filter, jlong __functionAddress) {
	GLXContext dstCtx = (GLXContext)(intptr_t)dstCtxAddress;
	glXglXBlitContextFramebufferAMDPROC glXglXBlitContextFramebufferAMD = (glXglXBlitContextFramebufferAMDPROC)(intptr_t)__functionAddress;
	glXglXBlitContextFramebufferAMD(dstCtx, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
}
