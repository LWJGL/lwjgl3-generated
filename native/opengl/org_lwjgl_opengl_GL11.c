...
typedef GLvoid (APIENTRY *glEndPROC) ();
...
typedef GLvoid (APIENTRY *glFinishPROC) ();
typedef GLvoid (APIENTRY *glFlushPROC) ();
...
typedef GLvoid (APIENTRY *glInitNamesPROC) ();
...
typedef GLvoid (APIENTRY *glLoadIdentityPROC) ();
...
typedef GLvoid (APIENTRY *glEndListPROC) ();
...
typedef GLvoid (APIENTRY *glPopAttribPROC) ();
typedef GLvoid (APIENTRY *glPopClientAttribPROC) ();
typedef GLvoid (APIENTRY *glPopMatrixPROC) ();
typedef GLvoid (APIENTRY *glPopNamePROC) ();
typedef GLvoid (APIENTRY *glPrioritizeTexturesPROC) (GLsizei, const GLuint *, const GLfloat *);
typedef GLvoid (APIENTRY *glPushMatrixPROC) ();
