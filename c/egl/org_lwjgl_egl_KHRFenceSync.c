...
JNIEXPORT jlong JNICALL Java_org_lwjgl_egl_KHRFenceSync_neglCreateSyncKHR(JNIEnv *__env, jclass clazz, jlong dpyAddress, jint type, jlong attrib_listAddress, jlong __functionAddress) {
...
JNIEXPORT jboolean JNICALL Java_org_lwjgl_egl_KHRFenceSync_neglDestroySyncKHR(JNIEnv *__env, jclass clazz, jlong dpyAddress, jlong syncAddress, jlong __functionAddress) {
	EGLDisplay dpy = (EGLDisplay)(intptr_t)dpyAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_egl_KHRFenceSync_neglClientWaitSyncKHR(JNIEnv *__env, jclass clazz, jlong dpyAddress, jlong syncAddress, jint flags, jlong timeout, jlong __functionAddress) {
	EGLDisplay dpy = (EGLDisplay)(intptr_t)dpyAddress;
	EGLSyncKHR sync = (EGLSyncKHR)(intptr_t)syncAddress;
...
JNIEXPORT jboolean JNICALL Java_org_lwjgl_egl_KHRFenceSync_neglGetSyncAttribKHR(JNIEnv *__env, jclass clazz, jlong dpyAddress, jlong syncAddress, jint attribute, jlong valueAddress, jlong __functionAddress) {
	EGLDisplay dpy = (EGLDisplay)(intptr_t)dpyAddress;
	EGLSyncKHR sync = (EGLSyncKHR)(intptr_t)syncAddress;
