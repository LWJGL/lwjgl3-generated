...
JNIEXPORT jint JNICALL Java_org_lwjgl_ovr_OVRGL_novrHmd_1CreateMirrorTextureGL(JNIEnv *__env, jclass clazz, jlong hmdAddress, jint format, jint width, jint height, jlong outMirrorTextureAddress) {
	ovrHmd hmd = (ovrHmd)(intptr_t)hmdAddress;
	ovrTexture **outMirrorTexture = (ovrTexture **)(intptr_t)outMirrorTextureAddress;
	UNUSED_PARAMS(__env, clazz)
	return (jint)ovrHmd_CreateMirrorTextureGL(hmd, format, width, height, outMirrorTexture);
}
