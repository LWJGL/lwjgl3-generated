...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTDrawInstanced_nglDrawArraysInstancedEXT(JNIEnv *__env, jclass clazz, jint mode, jint start, jint count, jint primcount) {
