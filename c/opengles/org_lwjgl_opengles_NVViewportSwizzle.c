...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVViewportSwizzle_nglViewportSwizzleNV(JNIEnv *__env, jclass clazz, jint index, jint swizzlex, jint swizzley, jint swizzlez, jint swizzlew) {
