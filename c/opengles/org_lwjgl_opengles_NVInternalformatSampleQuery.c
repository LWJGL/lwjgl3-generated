...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVInternalformatSampleQuery_nglGetInternalformatSampleivNV(JNIEnv *__env, jclass clazz, jint target, jint internalformat, jint samples, jint pname, jint bufSize, jlong paramsAddress, jlong __functionAddress) {
