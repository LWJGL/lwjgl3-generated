...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVConditionalRender_nglBeginConditionalRenderNV(JNIEnv *__env, jclass clazz, jint id, jint mode, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVConditionalRender_nglEndConditionalRenderNV(JNIEnv *__env, jclass clazz, jlong __functionAddress) {
