...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFragmentCoverageToColor_nglFragmentCoverageColorNV(JNIEnv *__env, jclass clazz, jint color, jlong __functionAddress) {
