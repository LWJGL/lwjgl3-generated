...
JNIEXPORT jlong JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglGetTextureHandleNV(JNIEnv *__env, jclass clazz, jint texture, jlong __functionAddress) {
...
JNIEXPORT jlong JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglGetTextureSamplerHandleNV(JNIEnv *__env, jclass clazz, jint texture, jint sampler, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglMakeTextureHandleResidentNV(JNIEnv *__env, jclass clazz, jlong handle, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglMakeTextureHandleNonResidentNV(JNIEnv *__env, jclass clazz, jlong handle, jlong __functionAddress) {
...
JNIEXPORT jlong JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglGetImageHandleNV(JNIEnv *__env, jclass clazz, jint texture, jint level, jboolean layered, jint layer, jint format, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglMakeImageHandleResidentNV(JNIEnv *__env, jclass clazz, jlong handle, jint access, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglMakeImageHandleNonResidentNV(JNIEnv *__env, jclass clazz, jlong handle, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglUniformHandleui64NV(JNIEnv *__env, jclass clazz, jint location, jlong value, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglUniformHandleui64vNV(JNIEnv *__env, jclass clazz, jint location, jint count, jlong valuesAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglProgramUniformHandleui64NV(JNIEnv *__env, jclass clazz, jint program, jint location, jlong value, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglProgramUniformHandleui64vNV(JNIEnv *__env, jclass clazz, jint program, jint location, jint count, jlong valuesAddress, jlong __functionAddress) {
	const GLuint64 *values = (const GLuint64 *)(intptr_t)valuesAddress;
...
JNIEXPORT jboolean JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglIsTextureHandleResidentNV(JNIEnv *__env, jclass clazz, jlong handle, jlong __functionAddress) {
...
JNIEXPORT jboolean JNICALL Java_org_lwjgl_opengles_NVBindlessTexture_nglIsImageHandleResidentNV(JNIEnv *__env, jclass clazz, jlong handle, jlong __functionAddress) {
