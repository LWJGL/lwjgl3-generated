...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTDebugMarker_nglInsertEventMarkerEXT(JNIEnv *__env, jclass clazz, jint length, jlong markerAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTDebugMarker_nglPushGroupMarkerEXT(JNIEnv *__env, jclass clazz, jint length, jlong markerAddress, jlong __functionAddress) {
	const GLchar *marker = (const GLchar *)(intptr_t)markerAddress;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTDebugMarker_nglPopGroupMarkerEXT(JNIEnv *__env, jclass clazz, jlong __functionAddress) {
