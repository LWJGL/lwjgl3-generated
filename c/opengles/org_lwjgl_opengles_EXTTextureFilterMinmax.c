...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTTextureFilterMinmax_nglRasterSamplesEXT(JNIEnv *__env, jclass clazz, jint samples, jboolean fixedsamplelocations) {
