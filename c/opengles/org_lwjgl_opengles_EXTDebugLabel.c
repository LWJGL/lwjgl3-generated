...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTDebugLabel_nglLabelObjectEXT(JNIEnv *__env, jclass clazz, jint type, jint object, jint length, jlong labelAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTDebugLabel_nglGetObjectLabelEXT(JNIEnv *__env, jclass clazz, jint type, jint object, jint bufSize, jlong lengthAddress, jlong labelAddress, jlong __functionAddress) {
