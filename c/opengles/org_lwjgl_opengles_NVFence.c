...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglDeleteFencesNV(JNIEnv *__env, jclass clazz, jint n, jlong fencesAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglGenFencesNV(JNIEnv *__env, jclass clazz, jint n, jlong fencesAddress, jlong __functionAddress) {
...
JNIEXPORT jboolean JNICALL Java_org_lwjgl_opengles_NVFence_nglIsFenceNV(JNIEnv *__env, jclass clazz, jint fence, jlong __functionAddress) {
	glIsFenceNVPROC glIsFenceNV = (glIsFenceNVPROC)(intptr_t)__functionAddress;
	UNUSED_PARAMS(__env, clazz)
	return (jboolean)glIsFenceNV(fence);
}

JNIEXPORT jboolean JNICALL Java_org_lwjgl_opengles_NVFence_nglTestFenceNV(JNIEnv *__env, jclass clazz, jint fence, jlong __functionAddress) {
	glTestFenceNVPROC glTestFenceNV = (glTestFenceNVPROC)(intptr_t)__functionAddress;
	UNUSED_PARAMS(__env, clazz)
	return (jboolean)glTestFenceNV(fence);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglGetFenceivNV(JNIEnv *__env, jclass clazz, jint fence, jint pname, jlong paramsAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglFinishFenceNV(JNIEnv *__env, jclass clazz, jint fence, jlong __functionAddress) {
	glFinishFenceNVPROC glFinishFenceNV = (glFinishFenceNVPROC)(intptr_t)__functionAddress;
	UNUSED_PARAMS(__env, clazz)
	glFinishFenceNV(fence);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglSetFenceNV(JNIEnv *__env, jclass clazz, jint fence, jint condition, jlong __functionAddress) {
