...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglDeleteFencesNV__IJ(JNIEnv *__env, jclass clazz, jint n, jlong fencesAddress) {
	glDeleteFencesNVPROC glDeleteFencesNV = (glDeleteFencesNVPROC)tlsGetFunction(117);
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglGenFencesNV__IJ(JNIEnv *__env, jclass clazz, jint n, jlong fencesAddress) {
	glGenFencesNVPROC glGenFencesNV = (glGenFencesNVPROC)tlsGetFunction(238);
	intptr_t fences = (intptr_t)fencesAddress;
	UNUSED_PARAM(clazz)
	glGenFencesNV(n, fences);
}

JNIEXPORT jboolean JNICALL Java_org_lwjgl_opengles_NVFence_nglIsFenceNV(JNIEnv *__env, jclass clazz, jint fence) {
	glIsFenceNVPROC glIsFenceNV = (glIsFenceNVPROC)tlsGetFunction(407);
	UNUSED_PARAM(clazz)
	return (jboolean)glIsFenceNV(fence);
}

JNIEXPORT jboolean JNICALL Java_org_lwjgl_opengles_NVFence_nglTestFenceNV(JNIEnv *__env, jclass clazz, jint fence) {
	glTestFenceNVPROC glTestFenceNV = (glTestFenceNVPROC)tlsGetFunction(643);
	UNUSED_PARAM(clazz)
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglGetFenceivNV__IIJ(JNIEnv *__env, jclass clazz, jint fence, jint pname, jlong paramsAddress) {
	glGetFenceivNVPROC glGetFenceivNV = (glGetFenceivNVPROC)tlsGetFunction(272);
	intptr_t params = (intptr_t)paramsAddress;
	UNUSED_PARAM(clazz)
	glGetFenceivNV(fence, pname, params);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglFinishFenceNV(JNIEnv *__env, jclass clazz, jint fence) {
	glFinishFenceNVPROC glFinishFenceNV = (glFinishFenceNVPROC)tlsGetFunction(214);
	UNUSED_PARAM(clazz)
	glFinishFenceNV(fence);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVFence_nglSetFenceNV(JNIEnv *__env, jclass clazz, jint fence, jint condition) {
