...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBlendEquationAdvanced_nglBlendParameteriNV(JNIEnv *__env, jclass clazz, jint pname, jint value, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_NVBlendEquationAdvanced_nglBlendBarrierNV(JNIEnv *__env, jclass clazz, jlong __functionAddress) {
