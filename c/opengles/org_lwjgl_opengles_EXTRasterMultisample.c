...
JNIEXPORT void JNICALL Java_org_lwjgl_opengles_EXTRasterMultisample_nglRasterSamplesEXT(JNIEnv *__env, jclass clazz, jint samples, jboolean fixedsamplelocations) {
