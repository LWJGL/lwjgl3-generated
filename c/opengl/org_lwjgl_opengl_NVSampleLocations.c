...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVSampleLocations_nglFramebufferSampleLocationsfvNV(JNIEnv *__env, jclass clazz, jint target, jint start, jint count, jlong vAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVSampleLocations_nglNamedFramebufferSampleLocationsfvNV(JNIEnv *__env, jclass clazz, jint framebuffer, jint start, jint count, jlong vAddress, jlong __functionAddress) {
	const GLfloat *v = (const GLfloat *)(intptr_t)vAddress;
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_NVSampleLocations_nglResolveDepthValuesNV(JNIEnv *__env, jclass clazz, jlong __functionAddress) {
