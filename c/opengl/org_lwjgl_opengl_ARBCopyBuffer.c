...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_ARBCopyBuffer_nglCopyBufferSubData(JNIEnv *__env, jclass clazz, jint readTarget, jint writeTarget, jlong readOffset, jlong writeOffset, jlong size) {
