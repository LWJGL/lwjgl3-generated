...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_AMDInterleavedElements_nglVertexAttribParameteriAMD(JNIEnv *__env, jclass clazz, jint index, jint pname, jint param) {
