...
typedef void (APIENTRY *glClearBufferivPROC) (GLenum, GLint, GLint *);
typedef void (APIENTRY *glClearBufferuivPROC) (GLenum, GLint, GLint *);
typedef void (APIENTRY *glClearBufferfvPROC) (GLenum, GLint, GLfloat *);
typedef void (APIENTRY *glClearBufferfiPROC) (GLenum, GLint, GLfloat, GLint);
typedef void (APIENTRY *glVertexAttribI1iPROC) (GLuint, GLint);
typedef void (APIENTRY *glVertexAttribI2iPROC) (GLuint, GLint, GLint);
typedef void (APIENTRY *glVertexAttribI3iPROC) (GLuint, GLint, GLint, GLint);
typedef void (APIENTRY *glVertexAttribI4iPROC) (GLuint, GLint, GLint, GLint, GLint);
typedef void (APIENTRY *glVertexAttribI1uiPROC) (GLuint, GLuint);
typedef void (APIENTRY *glVertexAttribI2uiPROC) (GLuint, GLuint, GLuint);
typedef void (APIENTRY *glVertexAttribI3uiPROC) (GLuint, GLint, GLint, GLint);
typedef void (APIENTRY *glVertexAttribI4uiPROC) (GLuint, GLint, GLint, GLint, GLint);
typedef void (APIENTRY *glVertexAttribI1ivPROC) (GLuint, const GLint *);
typedef void (APIENTRY *glVertexAttribI2ivPROC) (GLuint, const GLint *);
typedef void (APIENTRY *glVertexAttribI3ivPROC) (GLuint, const GLint *);
typedef void (APIENTRY *glVertexAttribI4ivPROC) (GLuint, const GLint *);
typedef void (APIENTRY *glVertexAttribI1uivPROC) (GLuint, const GLuint *);
typedef void (APIENTRY *glVertexAttribI2uivPROC) (GLuint, const GLuint *);
typedef void (APIENTRY *glVertexAttribI3uivPROC) (GLuint, const GLuint *);
typedef void (APIENTRY *glVertexAttribI4uivPROC) (GLuint, const GLuint *);
typedef void (APIENTRY *glVertexAttribI4bvPROC) (GLuint, const GLbyte *);
typedef void (APIENTRY *glVertexAttribI4svPROC) (GLuint, const GLshort *);
typedef void (APIENTRY *glVertexAttribI4ubvPROC) (GLuint, const GLbyte *);
typedef void (APIENTRY *glVertexAttribI4usvPROC) (GLuint, const GLshort *);
...
typedef void (APIENTRY *glBindFragDataLocationPROC) (GLuint, GLuint, const GLchar *);
typedef GLint (APIENTRY *glGetFragDataLocationPROC) (GLuint, const GLchar *);
typedef void (APIENTRY *glBeginConditionalRenderPROC) (GLuint, GLenum);
...
typedef void (APIENTRY *glClampColorPROC) (GLenum, GLenum);
...
typedef void (APIENTRY *glFramebufferTexture1DPROC) (GLenum, GLenum, GLenum, GLuint, GLint);
typedef void (APIENTRY *glFramebufferTexture2DPROC) (GLenum, GLenum, GLenum, GLuint, GLint);
typedef void (APIENTRY *glFramebufferTexture3DPROC) (GLenum, GLenum, GLenum, GLuint, GLint, GLint);
...
typedef void (APIENTRY *glTransformFeedbackVaryingsPROC) (GLuint, GLsizei, const GLchar **, GLenum);
