...
typedef GLvoid (APIENTRY *glDeleteObjectARBPROC) (GLhandleARB);
typedef GLhandleARB (APIENTRY *glGetHandleARBPROC) (GLenum);
typedef GLvoid (APIENTRY *glDetachObjectARBPROC) (GLhandleARB, GLhandleARB);
typedef GLhandleARB (APIENTRY *glCreateShaderObjectARBPROC) (GLenum);
typedef GLvoid (APIENTRY *glShaderSourceARBPROC) (GLhandleARB, GLsizei, const GLcharARB **, const GLint *);
typedef GLvoid (APIENTRY *glCompileShaderARBPROC) (GLhandleARB);
typedef GLhandleARB (APIENTRY *glCreateProgramObjectARBPROC) (void);
typedef GLvoid (APIENTRY *glAttachObjectARBPROC) (GLhandleARB, GLhandleARB);
typedef GLvoid (APIENTRY *glLinkProgramARBPROC) (GLhandleARB);
typedef GLvoid (APIENTRY *glUseProgramObjectARBPROC) (GLhandleARB);
typedef GLvoid (APIENTRY *glValidateProgramARBPROC) (GLhandleARB);
typedef GLvoid (APIENTRY *glUniform1fARBPROC) (GLint, GLfloat);
typedef GLvoid (APIENTRY *glUniform2fARBPROC) (GLint, GLfloat, GLfloat);
typedef GLvoid (APIENTRY *glUniform3fARBPROC) (GLint, GLfloat, GLfloat, GLfloat);
typedef GLvoid (APIENTRY *glUniform4fARBPROC) (GLint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef GLvoid (APIENTRY *glUniform1iARBPROC) (GLint, GLint);
typedef GLvoid (APIENTRY *glUniform2iARBPROC) (GLint, GLint, GLint);
typedef GLvoid (APIENTRY *glUniform3iARBPROC) (GLint, GLint, GLint, GLint);
typedef GLvoid (APIENTRY *glUniform4iARBPROC) (GLint, GLint, GLint, GLint, GLint);
typedef GLvoid (APIENTRY *glUniform1fvARBPROC) (GLint, GLsizei, const GLfloat *);
typedef GLvoid (APIENTRY *glUniform2fvARBPROC) (GLint, GLsizei, const GLfloat *);
typedef GLvoid (APIENTRY *glUniform3fvARBPROC) (GLint, GLsizei, const GLfloat *);
typedef GLvoid (APIENTRY *glUniform4fvARBPROC) (GLint, GLsizei, const GLfloat *);
typedef GLvoid (APIENTRY *glUniform1ivARBPROC) (GLint, GLsizei, const GLint *);
typedef GLvoid (APIENTRY *glUniform2ivARBPROC) (GLint, GLsizei, const GLint *);
typedef GLvoid (APIENTRY *glUniform3ivARBPROC) (GLint, GLsizei, const GLint *);
typedef GLvoid (APIENTRY *glUniform4ivARBPROC) (GLint, GLsizei, const GLint *);
typedef GLvoid (APIENTRY *glUniformMatrix2fvARBPROC) (GLint, GLsizei, GLboolean, const GLfloat *);
typedef GLvoid (APIENTRY *glUniformMatrix3fvARBPROC) (GLint, GLsizei, GLboolean, const GLfloat *);
typedef GLvoid (APIENTRY *glUniformMatrix4fvARBPROC) (GLint, GLsizei, GLboolean, const GLfloat *);
typedef GLvoid (APIENTRY *glGetObjectParameterfvARBPROC) (GLhandleARB, GLenum, GLfloat *);
typedef GLvoid (APIENTRY *glGetObjectParameterivARBPROC) (GLhandleARB, GLenum, GLint *);
typedef GLvoid (APIENTRY *glGetInfoLogARBPROC) (GLhandleARB, GLsizei, GLsizei *, GLcharARB *);
typedef GLvoid (APIENTRY *glGetAttachedObjectsARBPROC) (GLhandleARB, GLsizei, GLsizei *, GLhandleARB *);
typedef GLint (APIENTRY *glGetUniformLocationARBPROC) (GLhandleARB, const GLcharARB *);
typedef GLvoid (APIENTRY *glGetActiveUniformARBPROC) (GLhandleARB, GLuint, GLsizei, GLsizei *, GLint *, GLenum *, GLcharARB *);
typedef GLvoid (APIENTRY *glGetUniformfvARBPROC) (GLhandleARB, GLint, GLfloat *);
typedef GLvoid (APIENTRY *glGetUniformivARBPROC) (GLhandleARB, GLint, GLint *);
typedef GLvoid (APIENTRY *glGetShaderSourceARBPROC) (GLhandleARB, GLsizei, GLsizei *, GLcharARB *);
