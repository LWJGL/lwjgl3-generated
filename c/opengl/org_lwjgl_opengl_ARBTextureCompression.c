...
typedef GLvoid (APIENTRY *glCompressedTexImage3DARBPROC) (GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *);
typedef GLvoid (APIENTRY *glCompressedTexImage2DARBPROC) (GLenum, GLint, GLenum, GLsizei, GLsizei, GLint, GLsizei, const GLvoid *);
typedef GLvoid (APIENTRY *glCompressedTexImage1DARBPROC) (GLenum, GLint, GLenum, GLsizei, GLint, GLsizei, const GLvoid *);
typedef GLvoid (APIENTRY *glCompressedTexSubImage3DARBPROC) (GLenum, GLint, GLint, GLint, GLint, GLsizei, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *);
typedef GLvoid (APIENTRY *glCompressedTexSubImage2DARBPROC) (GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLsizei, const GLvoid *);
typedef GLvoid (APIENTRY *glCompressedTexSubImage1DARBPROC) (GLenum, GLint, GLint, GLsizei, GLenum, GLsizei, const GLvoid *);
typedef GLvoid (APIENTRY *glGetCompressedTexImageARBPROC) (GLenum, GLint, GLvoid *);
