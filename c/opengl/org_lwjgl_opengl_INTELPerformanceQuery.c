...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglBeginPerfQueryINTEL(JNIEnv *__env, jclass clazz, jint queryHandle, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglCreatePerfQueryINTEL(JNIEnv *__env, jclass clazz, jint queryId, jlong queryHandleAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglDeletePerfQueryINTEL(JNIEnv *__env, jclass clazz, jint queryHandle, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglEndPerfQueryINTEL(JNIEnv *__env, jclass clazz, jint queryHandle, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglGetFirstPerfQueryIdINTEL(JNIEnv *__env, jclass clazz, jlong queryIdAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglGetNextPerfQueryIdINTEL(JNIEnv *__env, jclass clazz, jint queryId, jlong nextQueryIdAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglGetPerfQueryDataINTEL(JNIEnv *__env, jclass clazz, jint queryHandle, jint flags, jint dataSize, jlong dataAddress, jlong bytesWrittenAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglGetPerfQueryIdByNameINTEL(JNIEnv *__env, jclass clazz, jlong queryNameAddress, jlong queryIdAddress, jlong __functionAddress) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_INTELPerformanceQuery_nglGetPerfQueryInfoINTEL(JNIEnv *__env, jclass clazz, jint queryId, jint queryNameLength, jlong queryNameAddress, jlong dataSizeAddress, jlong noCountersAddress, jlong noInstancesAddress, jlong capsMaskAddress, jlong __functionAddress) {
	GLchar *queryName = (GLchar *)(intptr_t)queryNameAddress;
