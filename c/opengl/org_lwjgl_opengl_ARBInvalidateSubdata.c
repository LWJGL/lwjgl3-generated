...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_ARBInvalidateSubdata_nglInvalidateTexSubImage(JNIEnv *__env, jclass clazz, jint texture, jint level, jint xoffset, jint yoffset, jint zoffset, jint width, jint height, jint depth) {
	glInvalidateTexSubImagePROC glInvalidateTexSubImage = (glInvalidateTexSubImagePROC)tlsGetFunction(853);
	UNUSED_PARAM(clazz)
	glInvalidateTexSubImage(texture, level, xoffset, yoffset, zoffset, width, height, depth);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengl_ARBInvalidateSubdata_nglInvalidateTexImage(JNIEnv *__env, jclass clazz, jint texture, jint level) {
	glInvalidateTexImagePROC glInvalidateTexImage = (glInvalidateTexImagePROC)tlsGetFunction(852);
	UNUSED_PARAM(clazz)
	glInvalidateTexImage(texture, level);
}

JNIEXPORT void JNICALL Java_org_lwjgl_opengl_ARBInvalidateSubdata_nglInvalidateBufferSubData(JNIEnv *__env, jclass clazz, jint buffer, jlong offset, jlong length) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_opengl_ARBInvalidateSubdata_nglInvalidateBufferData(JNIEnv *__env, jclass clazz, jint buffer) {
