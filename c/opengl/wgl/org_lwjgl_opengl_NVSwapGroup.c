...
JNIEXPORT jint JNICALL Java_org_lwjgl_opengl_NVSwapGroup_nwglJoinSwapGroupNV(JNIEnv *__env, jclass clazz, jlong hDCAddress, jint group, jlong __functionAddress) {
...
JNIEXPORT jint JNICALL Java_org_lwjgl_opengl_NVSwapGroup_nwglBindSwapBarrierNV(JNIEnv *__env, jclass clazz, jint group, jint barrier, jlong __functionAddress) {
...
JNIEXPORT jint JNICALL Java_org_lwjgl_opengl_NVSwapGroup_nwglQuerySwapGroupNV(JNIEnv *__env, jclass clazz, jlong hDCAddress, jlong groupAddress, jlong barrierAddress, jlong __functionAddress) {
	HDC hDC = (HDC)(intptr_t)hDCAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_opengl_NVSwapGroup_nwglQueryMaxSwapGroupsNV(JNIEnv *__env, jclass clazz, jlong hDCAddress, jlong maxGroupsAddress, jlong maxBarriersAddress, jlong __functionAddress) {
	HDC hDC = (HDC)(intptr_t)hDCAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_opengl_NVSwapGroup_nwglQueryFrameCountNV(JNIEnv *__env, jclass clazz, jlong hDCAddress, jlong countAddress, jlong __functionAddress) {
	HDC hDC = (HDC)(intptr_t)hDCAddress;
...
JNIEXPORT jint JNICALL Java_org_lwjgl_opengl_NVSwapGroup_nwglResetFrameCountNV(JNIEnv *__env, jclass clazz, jlong hDCAddress, jlong __functionAddress) {
	HDC hDC = (HDC)(intptr_t)hDCAddress;
