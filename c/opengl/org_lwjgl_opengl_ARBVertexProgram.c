...
typedef void (APIENTRY *glProgramStringARBPROC) (GLenum, GLenum, GLsizei, const void *);
typedef void (APIENTRY *glBindProgramARBPROC) (GLenum, GLuint);
typedef void (APIENTRY *glDeleteProgramsARBPROC) (GLsizei, const GLuint *);
typedef void (APIENTRY *glGenProgramsARBPROC) (GLsizei, GLuint *);
typedef void (APIENTRY *glProgramEnvParameter4dARBPROC) (GLenum, GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
typedef void (APIENTRY *glProgramEnvParameter4dvARBPROC) (GLenum, GLuint, const GLdouble *);
typedef void (APIENTRY *glProgramEnvParameter4fARBPROC) (GLenum, GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void (APIENTRY *glProgramEnvParameter4fvARBPROC) (GLenum, GLuint, const GLfloat *);
typedef void (APIENTRY *glProgramLocalParameter4dARBPROC) (GLenum, GLuint, GLdouble, GLdouble, GLdouble, GLdouble);
typedef void (APIENTRY *glProgramLocalParameter4dvARBPROC) (GLenum, GLuint, const GLdouble *);
typedef void (APIENTRY *glProgramLocalParameter4fARBPROC) (GLenum, GLuint, GLfloat, GLfloat, GLfloat, GLfloat);
typedef void (APIENTRY *glProgramLocalParameter4fvARBPROC) (GLenum, GLuint, const GLfloat *);
typedef void (APIENTRY *glGetProgramEnvParameterfvARBPROC) (GLenum, GLuint, GLfloat *);
typedef void (APIENTRY *glGetProgramEnvParameterdvARBPROC) (GLenum, GLuint, GLdouble *);
typedef void (APIENTRY *glGetProgramLocalParameterfvARBPROC) (GLenum, GLuint, GLfloat *);
typedef void (APIENTRY *glGetProgramLocalParameterdvARBPROC) (GLenum, GLuint, GLdouble *);
typedef void (APIENTRY *glGetProgramivARBPROC) (GLenum, GLenum, GLint *);
typedef void (APIENTRY *glGetProgramStringARBPROC) (GLenum, GLenum, void *);
