...
JNIEXPORT jlong JNICALL Java_org_lwjgl_system_xxhash_XXHash_XXH32_1createState(JNIEnv *__env, jclass clazz) {
	UNUSED_PARAMS(__env, clazz)
...
JNIEXPORT jlong JNICALL Java_org_lwjgl_system_xxhash_XXHash_XXH64_1createState(JNIEnv *__env, jclass clazz) {
	UNUSED_PARAMS(__env, clazz)
...
JNIEXPORT void JNICALL Java_org_lwjgl_system_xxhash_XXHash_nXXH32_1canonicalFromHash(JNIEnv *__env, jclass clazz, jlong dstAddress, jint hash) {
	XXH32_canonical_t *dst = (XXH32_canonical_t *)(intptr_t)dstAddress;
	UNUSED_PARAMS(__env, clazz)
	XXH32_canonicalFromHash(dst, hash);
}

JNIEXPORT void JNICALL Java_org_lwjgl_system_xxhash_XXHash_nXXH64_1canonicalFromHash(JNIEnv *__env, jclass clazz, jlong dstAddress, jlong hash) {
	XXH64_canonical_t *dst = (XXH64_canonical_t *)(intptr_t)dstAddress;
	UNUSED_PARAMS(__env, clazz)
	XXH64_canonicalFromHash(dst, hash);
}

JNIEXPORT jint JNICALL Java_org_lwjgl_system_xxhash_XXHash_nXXH32_1hashFromCanonical(JNIEnv *__env, jclass clazz, jlong srcAddress) {
	const XXH32_canonical_t *src = (const XXH32_canonical_t *)(intptr_t)srcAddress;
	UNUSED_PARAMS(__env, clazz)
	return (jint)XXH32_hashFromCanonical(src);
}

JNIEXPORT jlong JNICALL Java_org_lwjgl_system_xxhash_XXHash_nXXH64_1hashFromCanonical(JNIEnv *__env, jclass clazz, jlong srcAddress) {
