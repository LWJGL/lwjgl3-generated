...
public class VkIOSSurfaceCreateInfoMVK extends Struct implements NativeResource {
    ...
    VkIOSSurfaceCreateInfoMVK(long address, @Nullable ByteBuffer container) {
    ...
    public VkIOSSurfaceCreateInfoMVK pNext(@NativeType("void const *") long value) { npNext(address(), value); return this; }
    ...
    public VkIOSSurfaceCreateInfoMVK pView(@NativeType("void const *") long value) { npView(address(), value); return this; }
    ...
    /** Returns a new {@link VkIOSSurfaceCreateInfoMVK} instance for the specified memory address. */
    public static VkIOSSurfaceCreateInfoMVK create(long address) {
        return new VkIOSSurfaceCreateInfoMVK(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkIOSSurfaceCreateInfoMVK createSafe(long address) {
     ...
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer malloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer calloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer create(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkIOSSurfaceCreateInfoMVK.Buffer createSafe(long address, int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkIOSSurfaceCreateInfoMVK.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkIOSSurfaceCreateInfoMVK, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code pNext} field. */
        public VkIOSSurfaceCreateInfoMVK.Buffer pNext(@NativeType("void const *") long value) { VkIOSSurfaceCreateInfoMVK.npNext(address(), value); return this; }
        /** Sets the specified value to the {@code flags} field. */
        ...
        /** Sets the specified value to the {@code pView} field. */
        public VkIOSSurfaceCreateInfoMVK.Buffer pView(@NativeType("void const *") long value) { VkIOSSurfaceCreateInfoMVK.npView(address(), value); return this; }
