...
public class VkMemoryAllocateFlagsInfoKHX extends Struct implements NativeResource {
    ...
    VkMemoryAllocateFlagsInfoKHX(long address, @Nullable ByteBuffer container) {
    ...
    /** Returns a new {@link VkMemoryAllocateFlagsInfoKHX} instance for the specified memory address. */
    public static VkMemoryAllocateFlagsInfoKHX create(long address) {
        return new VkMemoryAllocateFlagsInfoKHX(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkMemoryAllocateFlagsInfoKHX createSafe(long address) {
     ...
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer malloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer calloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer create(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkMemoryAllocateFlagsInfoKHX.Buffer createSafe(long address, int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkMemoryAllocateFlagsInfoKHX.Buffer callocStack(int capacity, MemoryStack stack) {
