...
public class VkDeviceGroupPresentCapabilitiesKHX extends Struct implements NativeResource {
    ...
    VkDeviceGroupPresentCapabilitiesKHX(long address, @Nullable ByteBuffer container) {
    ...
    /** Returns a new {@link VkDeviceGroupPresentCapabilitiesKHX} instance for the specified memory address. */
    public static VkDeviceGroupPresentCapabilitiesKHX create(long address) {
        return new VkDeviceGroupPresentCapabilitiesKHX(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDeviceGroupPresentCapabilitiesKHX createSafe(long address) {
     ...
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer malloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer calloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer create(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer createSafe(long address, int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupPresentCapabilitiesKHX.Buffer callocStack(int capacity, MemoryStack stack) {
