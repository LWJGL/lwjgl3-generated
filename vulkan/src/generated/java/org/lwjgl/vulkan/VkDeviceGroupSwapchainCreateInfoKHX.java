...
public class VkDeviceGroupSwapchainCreateInfoKHX extends Struct implements NativeResource {
    ...
    VkDeviceGroupSwapchainCreateInfoKHX(long address, @Nullable ByteBuffer container) {
    ...
    public VkDeviceGroupSwapchainCreateInfoKHX pNext(@NativeType("void const *") long value) { npNext(address(), value); return this; }
    ...
    /** Returns a new {@link VkDeviceGroupSwapchainCreateInfoKHX} instance for the specified memory address. */
    public static VkDeviceGroupSwapchainCreateInfoKHX create(long address) {
        return new VkDeviceGroupSwapchainCreateInfoKHX(address, null);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDeviceGroupSwapchainCreateInfoKHX createSafe(long address) {
     ...
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer malloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer calloc(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer create(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer create(long address, int capacity) {
        return new Buffer(address, capacity);
    }

    /** Like {@link #create(long, int) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer createSafe(long address, int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer mallocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer callocStack(int capacity) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer mallocStack(int capacity, MemoryStack stack) {
     ...
     * @param capacity the buffer capacity
     */
    public static VkDeviceGroupSwapchainCreateInfoKHX.Buffer callocStack(int capacity, MemoryStack stack) {
    ...
    public static class Buffer extends StructBuffer<VkDeviceGroupSwapchainCreateInfoKHX, Buffer> implements NativeResource {
        ...
        /** Sets the specified value to the {@code pNext} field. */
        public VkDeviceGroupSwapchainCreateInfoKHX.Buffer pNext(@NativeType("void const *") long value) { VkDeviceGroupSwapchainCreateInfoKHX.npNext(address(), value); return this; }
        /** Sets the specified value to the {@code modes} field. */
