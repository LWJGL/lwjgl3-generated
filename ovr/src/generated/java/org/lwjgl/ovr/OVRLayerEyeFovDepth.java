...
public class OVRLayerEyeFovDepth extends Struct implements NativeResource {
    ...
    public static long nColorTexture(long struct, int index) {
        ...
        return memGetAddress(struct + OVRLayerEyeFovDepth.COLORTEXTURE + index * POINTER_SIZE);
    }
    ...
    public static long nDepthTexture(long struct, int index) {
        if (CHECKS) { check(index, ovrEye_Count); }
        return memGetAddress(struct + OVRLayerEyeFovDepth.DEPTHTEXTURE + index * POINTER_SIZE);
    }
    ...
    public static void nColorTexture(long struct, int index, long value) {
        if (CHECKS) { check(index, ovrEye_Count); }
        memPutAddress(struct + OVRLayerEyeFovDepth.COLORTEXTURE + index * POINTER_SIZE, value);
    }
    ...
    public static void nViewport(long struct, int index, OVRRecti value) {
        if (CHECKS) { check(index, ovrEye_Count); }
        memCopy(value.address(), struct + OVRLayerEyeFovDepth.VIEWPORT + index * OVRRecti.SIZEOF, OVRRecti.SIZEOF);
    }
    ...
    public static void nFov(long struct, int index, OVRFovPort value) {
        if (CHECKS) { check(index, ovrEye_Count); }
        memCopy(value.address(), struct + OVRLayerEyeFovDepth.FOV + index * OVRFovPort.SIZEOF, OVRFovPort.SIZEOF);
    }
    ...
    public static void nRenderPose(long struct, int index, OVRPosef value) {
        if (CHECKS) { check(index, ovrEye_Count); }
        memCopy(value.address(), struct + OVRLayerEyeFovDepth.RENDERPOSE + index * OVRPosef.SIZEOF, OVRPosef.SIZEOF);
    }
    ...
    public static void nDepthTexture(long struct, int index, long value) {
        if (CHECKS) { check(index, ovrEye_Count); }
        memPutAddress(struct + OVRLayerEyeFovDepth.DEPTHTEXTURE + index * POINTER_SIZE, value);
    }
